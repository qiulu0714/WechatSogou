...
<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:dcr="http://www.isocat.org/ns/dcr" xmlns:tei="http://www.tei-c.org/ns/1.0" xmlns:teix="http://www.tei-c.org/ns/Examples" elementFormDefault="qualified" targetNamespace="http://www.tei-c.org/ns/1.0">
  <xs:import namespace="http://www.isocat.org/ns/dcr" schemaLocation="tei_all_dcr.xsd"/>
  ...
  <xs:simpleType name="data.enumerated">
    <xs:restriction base="tei:data.word"/>
  </xs:simpleType>
  <xs:group name="macro.schemaPattern">
    <xs:sequence>
      <xs:group ref="tei:macro.anyXML"/>
    </xs:sequence>
  </xs:group>
...
Sample values include: 1] all; 2] most; 3] range</xs:documentation>
  ...
  <xs:attributeGroup name="att.damaged.attributes">
    ...
    <xs:attributeGroup ref="tei:att.damaged.attribute.agent"/>
    <xs:attributeGroup ref="tei:att.damaged.attribute.degree"/>
    <xs:attributeGroup ref="tei:att.damaged.attribute.group"/>
  </xs:attributeGroup>
...
Sample values include: 1] approved; 2] candidate; 3] cleared; 4] deprecated; 5] draft; 6] embargoed; 7] expired; 8] frozen; 9] galley; 10] proposed; 11] published; 12] recommendation; 13] submitted; 14] unfinished; 15] withdrawn</xs:documentation>
  ...
  <xs:attributeGroup name="att.duration.w3c.attributes">
    <xs:attributeGroup ref="tei:att.duration.w3c.attribute.dur"/>
  </xs:attributeGroup>
  ...
  <xs:attributeGroup name="att.duration.iso.attributes">
    <xs:attributeGroup ref="tei:att.duration.iso.attribute.dur-iso"/>
  </xs:attributeGroup>
...
Suggested values include: 1] internal; 2] external; 3] conjecture</xs:documentation>
  ...
  <xs:attributeGroup name="att.interpLike.attributes">
    <xs:attributeGroup ref="tei:att.source.attributes"/>
    <xs:attributeGroup ref="tei:att.interpLike.attribute.type"/>
    <xs:attributeGroup ref="tei:att.interpLike.attribute.inst"/>
  </xs:attributeGroup>
...
Suggested values include: 1] below; 2] bottom; 3] margin; 4] top; 5] opposite; 6] overleaf; 7] above; 8] end; 9] inline; 10] inspace</xs:documentation>
  ...
  <xs:attributeGroup name="att.pointing.group.attributes">
    ...
    <xs:attributeGroup ref="tei:att.pointing.group.attribute.domains"/>
    <xs:attributeGroup ref="tei:att.pointing.group.attribute.targFunc"/>
  </xs:attributeGroup>
  ...
  <xs:attributeGroup name="att.readFrom.attributes">
    <xs:attributeGroup ref="tei:att.readFrom.attribute.source"/>
  </xs:attributeGroup>
  ...
  <xs:attributeGroup name="att.scoping.attributes">
    <xs:attributeGroup ref="tei:att.scoping.attribute.target"/>
    <xs:attributeGroup ref="tei:att.scoping.attribute.match"/>
  </xs:attributeGroup>
...
Sample values include: 1] duplicate; 2] duplicate-partial; 3] excessStart; 4] excessEnd; 5] shortStart; 6] shortEnd; 7] partial; 8] unremarkable</xs:documentation>
  ...
  <xs:attributeGroup name="att.transcriptional.attribute.cause">
    <xs:attribute name="cause">
      <xs:annotation>
        <xs:documentation>documents the presumed cause for the intervention.
Suggested values include: 1] fix; 2] unclear</xs:documentation>
      </xs:annotation>
      <xs:simpleType>
        <xs:union>
          <xs:simpleType>
...
Suggested values include: 1] volume; 2] issue; 3] page; 4] line; 5] chapter; 6] part; 7] column</xs:documentation>
  ...
  <xs:group name="model.measureLike_sequenceOptional">
    <xs:sequence>
      ...
      <xs:element minOccurs="0" ref="tei:dim"/>
  ...
  <xs:group name="model.measureLike_sequenceOptionalRepeatable">
    <xs:sequence>
      ...
      <xs:element minOccurs="0" maxOccurs="unbounded" ref="tei:dim"/>
  ...
  <xs:group name="model.measureLike_sequenceRepeatable">
    <xs:sequence>
      ...
      <xs:element maxOccurs="unbounded" ref="tei:dim"/>
  ...
  <xs:group name="model.graphicLike">
    <xs:choice>
      ...
      <xs:element ref="tei:binaryObject"/>
  ...
  <xs:group name="model.pPart.msdesc">
    <xs:choice>
      <xs:element ref="tei:catchwords"/>
      <xs:element ref="tei:dimensions"/>
      <xs:element ref="tei:heraldry"/>
      <xs:element ref="tei:locus"/>
      <xs:element ref="tei:locusGrp"/>
      <xs:element ref="tei:material"/>
      <xs:element ref="tei:objectType"/>
      <xs:element ref="tei:origDate"/>
      <xs:element ref="tei:origPlace"/>
      <xs:element ref="tei:secFol"/>
      <xs:element ref="tei:signatures"/>
      <xs:element ref="tei:stamp"/>
      <xs:element ref="tei:watermark"/>
    </xs:choice>
  </xs:group>
  ...
  <xs:group name="model.pPart.editorial_sequenceOptional">
    <xs:sequence>
      ...
      <xs:element minOccurs="0" ref="tei:am"/>
  ...
  <xs:group name="model.pPart.editorial_sequenceOptionalRepeatable">
    <xs:sequence>
      ...
      <xs:element minOccurs="0" maxOccurs="unbounded" ref="tei:am"/>
  ...
  <xs:group name="model.pPart.editorial_sequenceRepeatable">
    <xs:sequence>
      ...
      <xs:element maxOccurs="unbounded" ref="tei:am"/>
  ...
  <xs:group name="model.global.meta">
    <xs:choice>
      ...
      <xs:element ref="tei:interp"/>
      <xs:element ref="tei:interpGrp"/>
      <xs:element ref="tei:precision"/>
      <xs:element ref="tei:certainty"/>
      <xs:element ref="tei:respons"/>
  ...
  <xs:group name="model.oddDecl">
    <xs:choice>
      <xs:element ref="tei:moduleSpec"/>
      <xs:element ref="tei:specGrp"/>
      <xs:element ref="tei:specGrpRef"/>
      <xs:element ref="tei:elementSpec"/>
      <xs:element ref="tei:classSpec"/>
      <xs:element ref="tei:dataSpec"/>
      <xs:element ref="tei:macroSpec"/>
      <xs:element ref="tei:listRef"/>
      <xs:element ref="tei:outputRendition"/>
      <xs:element ref="tei:constraintSpec"/>
    </xs:choice>
  </xs:group>
  ...
  <xs:group name="model.oddDecl_sequenceOptional">
    <xs:sequence>
      <xs:element minOccurs="0" ref="tei:moduleSpec"/>
      <xs:element minOccurs="0" ref="tei:specGrp"/>
      <xs:element minOccurs="0" ref="tei:specGrpRef"/>
      <xs:element minOccurs="0" ref="tei:elementSpec"/>
      <xs:element minOccurs="0" ref="tei:classSpec"/>
      <xs:element minOccurs="0" ref="tei:dataSpec"/>
      <xs:element minOccurs="0" ref="tei:macroSpec"/>
      <xs:element minOccurs="0" ref="tei:listRef"/>
      <xs:element minOccurs="0" ref="tei:outputRendition"/>
      <xs:element minOccurs="0" ref="tei:constraintSpec"/>
    </xs:sequence>
  </xs:group>
  <xs:group name="model.oddDecl_sequenceOptionalRepeatable">
    <xs:sequence>
      <xs:element minOccurs="0" maxOccurs="unbounded" ref="tei:moduleSpec"/>
      <xs:element minOccurs="0" maxOccurs="unbounded" ref="tei:specGrp"/>
      <xs:element minOccurs="0" maxOccurs="unbounded" ref="tei:specGrpRef"/>
      <xs:element minOccurs="0" maxOccurs="unbounded" ref="tei:elementSpec"/>
      <xs:element minOccurs="0" maxOccurs="unbounded" ref="tei:classSpec"/>
      <xs:element minOccurs="0" maxOccurs="unbounded" ref="tei:dataSpec"/>
      <xs:element minOccurs="0" maxOccurs="unbounded" ref="tei:macroSpec"/>
      <xs:element minOccurs="0" maxOccurs="unbounded" ref="tei:listRef"/>
      <xs:element minOccurs="0" maxOccurs="unbounded" ref="tei:outputRendition"/>
      <xs:element minOccurs="0" maxOccurs="unbounded" ref="tei:constraintSpec"/>
    </xs:sequence>
  </xs:group>
  <xs:group name="model.oddDecl_sequenceRepeatable">
    <xs:sequence>
      <xs:element maxOccurs="unbounded" ref="tei:moduleSpec"/>
      <xs:element maxOccurs="unbounded" ref="tei:specGrp"/>
      <xs:element maxOccurs="unbounded" ref="tei:specGrpRef"/>
      <xs:element maxOccurs="unbounded" ref="tei:elementSpec"/>
      <xs:element maxOccurs="unbounded" ref="tei:classSpec"/>
      <xs:element maxOccurs="unbounded" ref="tei:dataSpec"/>
      <xs:element maxOccurs="unbounded" ref="tei:macroSpec"/>
      <xs:element maxOccurs="unbounded" ref="tei:listRef"/>
      <xs:element maxOccurs="unbounded" ref="tei:outputRendition"/>
      <xs:element maxOccurs="unbounded" ref="tei:constraintSpec"/>
    </xs:sequence>
  </xs:group>
  <xs:group name="model.oddRef">
    <xs:choice>
      <xs:element ref="tei:classRef"/>
      <xs:element ref="tei:elementRef"/>
      <xs:element ref="tei:macroRef"/>
      <xs:element ref="tei:moduleRef"/>
      <xs:element ref="tei:dataRef"/>
    </xs:choice>
  </xs:group>
  ...
  <xs:group name="model.specDescLike">
    <xs:choice>
      <xs:element ref="tei:specList"/>
      <xs:element ref="tei:specDesc"/>
    </xs:choice>
  </xs:group>
  ...
  <xs:group name="model.listLike">
    <xs:choice>
      ...
      <xs:element ref="tei:listApp"/>
      <xs:element ref="tei:listWit"/>
    </xs:choice>
  </xs:group>
  ...
  <xs:group name="model.listLike_sequenceOptional">
    <xs:sequence>
      ...
      <xs:element minOccurs="0" ref="tei:listApp"/>
      <xs:element minOccurs="0" ref="tei:listWit"/>
    </xs:sequence>
  </xs:group>
  <xs:group name="model.listLike_sequenceOptionalRepeatable">
    <xs:sequence>
      ...
      <xs:element minOccurs="0" maxOccurs="unbounded" ref="tei:listApp"/>
      <xs:element minOccurs="0" maxOccurs="unbounded" ref="tei:listWit"/>
    </xs:sequence>
  </xs:group>
  <xs:group name="model.listLike_sequenceRepeatable">
    <xs:sequence>
      ...
      <xs:element maxOccurs="unbounded" ref="tei:listApp"/>
      <xs:element maxOccurs="unbounded" ref="tei:listWit"/>
    </xs:sequence>
  </xs:group>
  ...
  <xs:group name="model.stageLike">
    <xs:choice>
      ...
      <xs:element ref="tei:move"/>
      <xs:element ref="tei:view"/>
      <xs:element ref="tei:camera"/>
      <xs:element ref="tei:sound"/>
      <xs:element ref="tei:caption"/>
      <xs:element ref="tei:tech"/>
    </xs:choice>
  </xs:group>
  ...
  <xs:group name="model.stageLike_sequenceOptional">
    <xs:sequence>
      ...
      <xs:element minOccurs="0" ref="tei:move"/>
      <xs:element minOccurs="0" ref="tei:view"/>
      <xs:element minOccurs="0" ref="tei:camera"/>
      <xs:element minOccurs="0" ref="tei:sound"/>
      <xs:element minOccurs="0" ref="tei:caption"/>
      <xs:element minOccurs="0" ref="tei:tech"/>
    </xs:sequence>
  </xs:group>
  <xs:group name="model.stageLike_sequenceOptionalRepeatable">
    <xs:sequence>
      <xs:element minOccurs="0" maxOccurs="unbounded" ref="tei:stage"/>
      <xs:element minOccurs="0" maxOccurs="unbounded" ref="tei:move"/>
      <xs:element minOccurs="0" maxOccurs="unbounded" ref="tei:view"/>
      <xs:element minOccurs="0" maxOccurs="unbounded" ref="tei:camera"/>
      <xs:element minOccurs="0" maxOccurs="unbounded" ref="tei:sound"/>
      <xs:element minOccurs="0" maxOccurs="unbounded" ref="tei:caption"/>
      <xs:element minOccurs="0" maxOccurs="unbounded" ref="tei:tech"/>
    </xs:sequence>
  </xs:group>
  <xs:group name="model.stageLike_sequenceRepeatable">
    <xs:sequence>
      <xs:element maxOccurs="unbounded" ref="tei:stage"/>
      <xs:element maxOccurs="unbounded" ref="tei:move"/>
      <xs:element maxOccurs="unbounded" ref="tei:view"/>
      <xs:element maxOccurs="unbounded" ref="tei:camera"/>
      <xs:element maxOccurs="unbounded" ref="tei:sound"/>
      <xs:element maxOccurs="unbounded" ref="tei:caption"/>
      <xs:element maxOccurs="unbounded" ref="tei:tech"/>
    </xs:sequence>
  </xs:group>
  <xs:group name="model.featureVal.complex">
    <xs:choice>
      ...
      <xs:element ref="tei:vNot"/>
      <xs:element ref="tei:vMerge"/>
    </xs:choice>
  </xs:group>
  <xs:group name="model.featureVal.single">
    <xs:choice>
      <xs:element ref="tei:binary"/>
      <xs:element ref="tei:symbol"/>
      <xs:element ref="tei:numeric"/>
      <xs:element ref="tei:string"/>
      <xs:element ref="tei:vLabel"/>
      <xs:element ref="tei:default"/>
      <xs:element ref="tei:vAlt"/>
    </xs:choice>
  </xs:group>
  ...
  <xs:group name="model.global.edit">
    <xs:choice>
      ...
      <xs:element ref="tei:app"/>
      <xs:element ref="tei:addSpan"/>
      <xs:element ref="tei:damageSpan"/>
      <xs:element ref="tei:delSpan"/>
      <xs:element ref="tei:space"/>
    </xs:choice>
  </xs:group>
  <xs:group name="model.divPart">
    <xs:choice>
      ...
      <xs:element ref="tei:graph"/>
      <xs:element ref="tei:tree"/>
      <xs:element ref="tei:eTree"/>
      <xs:element ref="tei:forest"/>
      <xs:element ref="tei:listForest"/>
      <xs:group ref="tei:model.divPart.spoken"/>
      <xs:element ref="tei:schemaSpec"/>
    </xs:choice>
  </xs:group>
  ...
  <xs:group name="model.personPart">
    <xs:choice>
      ...
      <xs:group ref="tei:model.eventLike"/>
  ...
  <xs:group name="model.glossLike">
    <xs:choice>
      <xs:element ref="tei:gloss"/>
      <xs:element ref="tei:equiv"/>
      <xs:element ref="tei:altIdent"/>
    </xs:choice>
  </xs:group>
  ...
  <xs:group name="model.frontPart.drama">
    <xs:choice>
      ...
      <xs:element ref="tei:prologue"/>
      <xs:element ref="tei:epilogue"/>
      <xs:element ref="tei:performance"/>
  ...
  <xs:group name="model.msQuoteLike">
    <xs:choice>
      <xs:element ref="tei:title"/>
      <xs:element ref="tei:colophon"/>
      <xs:element ref="tei:explicit"/>
      <xs:element ref="tei:finalRubric"/>
      <xs:element ref="tei:incipit"/>
      <xs:element ref="tei:rubric"/>
    </xs:choice>
  </xs:group>
  <xs:group name="model.msItemPart">
    <xs:choice>
      ...
      <xs:group ref="tei:model.msQuoteLike"/>
      <xs:element ref="tei:textLang"/>
      <xs:element ref="tei:idno"/>
      <xs:element ref="tei:filiation"/>
      <xs:element ref="tei:msItem"/>
      <xs:element ref="tei:msItemStruct"/>
  ...
  <xs:group name="model.nameLike">
    <xs:choice>
      ...
      <xs:group ref="tei:model.offsetLike"/>
  ...
  <xs:group name="model.nameLike_alternation">
    <xs:choice>
      ...
      <xs:group ref="tei:model.offsetLike_alternation"/>
  ...
  <xs:group name="model.nameLike_sequence">
    <xs:sequence>
      ...
      <xs:group ref="tei:model.offsetLike_sequence"/>
  ...
  <xs:group name="model.nameLike_sequenceOptional">
    <xs:sequence>
      ...
      <xs:group minOccurs="0" ref="tei:model.offsetLike_sequenceOptional"/>
  ...
  <xs:group name="model.nameLike_sequenceOptionalRepeatable">
    <xs:sequence>
      ...
      <xs:group minOccurs="0" maxOccurs="unbounded" ref="tei:model.offsetLike_sequenceOptionalRepeatable"/>
  ...
  <xs:group name="model.nameLike_sequenceRepeatable">
    <xs:sequence>
      ...
      <xs:group maxOccurs="unbounded" ref="tei:model.offsetLike_sequenceRepeatable"/>
      <xs:group maxOccurs="unbounded" ref="tei:model.placeStateLike_sequenceRepeatable"/>
      ...
      <xs:group maxOccurs="unbounded" ref="tei:model.persNamePart_sequenceRepeatable"/>
    </xs:sequence>
  </xs:group>
  <xs:group name="model.global">
    <xs:choice>
      <xs:group ref="tei:model.global.meta"/>
      ...
      <xs:group ref="tei:model.global.spoken"/>
      <xs:element ref="tei:metamark"/>
    </xs:choice>
  </xs:group>
  <xs:group name="model.featureVal">
    <xs:choice>
      <xs:group ref="tei:model.featureVal.complex"/>
      <xs:group ref="tei:model.featureVal.single"/>
    </xs:choice>
  </xs:group>
  ...
  <xs:group name="model.common">
    <xs:choice>
      <xs:group ref="tei:model.divPart"/>
      <xs:group ref="tei:model.inter"/>
      <xs:group ref="tei:model.entryLike"/>
    </xs:choice>
  </xs:group>
  <xs:group name="model.phrase">
    <xs:choice>
      ...
      <xs:group ref="tei:model.pPart.msdesc"/>
      ...
      <xs:group ref="tei:model.specDescLike"/>
      <xs:group ref="tei:model.pPart.data"/>
      <xs:group ref="tei:model.ptrLike.form"/>
    </xs:choice>
  </xs:group>
  ...
  <xs:group name="model.encodingDescPart">
    <xs:choice>
      ...
      <xs:element ref="tei:variantEncoding"/>
      <xs:element ref="tei:metDecl"/>
      <xs:element ref="tei:schemaSpec"/>
    </xs:choice>
  </xs:group>
  <xs:group name="model.editorialDeclPart">
    <xs:choice>
      <xs:element ref="tei:correction"/>
      <xs:element ref="tei:normalization"/>
      <xs:element ref="tei:quotation"/>
      <xs:element ref="tei:hyphenation"/>
      <xs:element ref="tei:segmentation"/>
      <xs:element ref="tei:stdVals"/>
      <xs:element ref="tei:interpretation"/>
      <xs:element ref="tei:punctuation"/>
    </xs:choice>
  </xs:group>
  ...
  <xs:attributeGroup name="att.source.attributes">
    <xs:attributeGroup ref="tei:att.source.attribute.source"/>
  </xs:attributeGroup>
...
Sample values include: 1] main; 2] sub(subordinate) ; 3] alt(alternate) ; 4] short; 5] desc(descriptive) </xs:documentation>
  ...
  <xs:element name="l">
    ...
    <xs:complexType mixed="true">
      ...
      <xs:attributeGroup ref="tei:att.global.attributes"/>
      <xs:attributeGroup ref="tei:att.metrical.attributes"/>
      <xs:attributeGroup ref="tei:att.enjamb.attributes"/>
      <xs:attributeGroup ref="tei:att.fragmentable.attributes"/>
    </xs:complexType>
  </xs:element>
  <xs:element name="lg">
...
Suggested values include: 1] setting; 2] entrance; 3] exit; 4] business; 5] novelistic; 6] delivery; 7] modifier; 8] location; 9] mixed</xs:documentation>
  ...
  <xs:element name="teiCorpus">
    <xs:annotation>
      <xs:documentation>contains the whole of a TEI encoded corpus, comprising a single corpus header and one or more TEI elements, each containing a single text header and a text. [4. Default Text Structure 15.1. Varieties of Composite Text]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:sequence>
        ...
        <xs:choice>
          <xs:sequence>
            <xs:group maxOccurs="unbounded" ref="tei:model.resourceLike"/>
            <xs:choice minOccurs="0" maxOccurs="unbounded">
...
Sample values include: 1] index; 2] toc; 3] figlist; 4] tablist</xs:documentation>
  ...
  <xs:element name="w">
    <xs:annotation>
      <xs:documentation>(word) represents a grammatical (not necessarily orthographic) word. [17.1. Linguistic Segment Categories]</xs:documentation>
    </xs:annotation>
    <xs:complexType mixed="true">
      <xs:choice minOccurs="0" maxOccurs="unbounded">
        <xs:group ref="tei:model.gLike"/>
  ...
  <xs:element name="span">
    ...
    <xs:complexType>
      <xs:complexContent>
        <xs:extension base="tei:macro.phraseSeq.limited">
          <xs:attributeGroup ref="tei:att.global.attributes"/>
          <xs:attributeGroup ref="tei:att.interpLike.attributes"/>
          <xs:attributeGroup ref="tei:att.pointing.attributes"/>
  ...
  <xs:element name="interp">
    <xs:annotation>
      <xs:documentation>(interpretation) summarizes a specific interpretative annotation which can be linked to a span of text. [17.3. Spans and Interpretations]</xs:documentation>
    </xs:annotation>
    <xs:complexType mixed="true">
      <xs:choice minOccurs="0" maxOccurs="unbounded">
        <xs:group ref="tei:model.gLike"/>
  ...
  <xs:element name="interpGrp">
    <xs:annotation>
      <xs:documentation>(interpretation group) collects together a set of related interpretations which share responsibility or type. [17.3. Spans and Interpretations]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:sequence>
        <xs:group minOccurs="0" maxOccurs="unbounded" ref="tei:model.descLike"/>
        <xs:element maxOccurs="unbounded" ref="tei:interp"/>
      </xs:sequence>
      <xs:attributeGroup ref="tei:att.global.attributes"/>
      <xs:attributeGroup ref="tei:att.interpLike.attributes"/>
    </xs:complexType>
  ...
  <xs:element name="precision">
    <xs:annotation>
      <xs:documentation>indicates the numerical accuracy or precision associated with some aspect of the text markup. [21.2. Indications of Precision]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:choice minOccurs="0" maxOccurs="unbounded">
        <xs:group ref="tei:model.descLike"/>
  ...
  <xs:element name="respons">
    <xs:annotation>
      <xs:documentation>(responsibility) identifies the individual(s) responsible for some aspect of the content or markup of particular element(s). [21.3. Attribution of Responsibility]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:choice minOccurs="0" maxOccurs="unbounded">
        <xs:group ref="tei:model.descLike"/>
...
Suggested values include: 1] persuade; 2] express; 3] inform; 4] entertain</xs:documentation>
    ...
    <xs:complexType>
      <xs:choice>
        ...
        <xs:choice minOccurs="0" maxOccurs="unbounded">
          <xs:group ref="tei:model.nameLike.agent"/>
          <xs:group ref="tei:model.dateLike"/>
          <xs:group ref="tei:model.settingPart"/>
        </xs:choice>
      </xs:choice>
      <xs:attributeGroup ref="tei:att.global.attributes"/>
      <xs:attributeGroup ref="tei:att.ascribed.attributes"/>
  ...
  <xs:attributeGroup name="att.entryLike.attributes">
    <xs:attributeGroup ref="tei:att.entryLike.attribute.type"/>
  </xs:attributeGroup>
...
Suggested values include: 1] main; 2] hom(homograph) ; 3] xref(cross reference) ; 4] affix; 5] abbr(abbreviation) ; 6] supplemental; 7] foreign</xs:documentation>
  ...
  <xs:attributeGroup name="att.lexicographic.attribute.location">
    <xs:attribute name="location" type="xs:anyURI">
      <xs:annotation>
        <xs:documentation>indicates an anchor element typically elsewhere in the document, but possibly in another document, which is the original location of this component.</xs:documentation>
      </xs:annotation>
    </xs:attribute>
  </xs:attributeGroup>
  ...
  <xs:group name="model.lexicalRefinement_alternation">
    <xs:choice>
      <xs:element ref="tei:gramGrp"/>
      <xs:element ref="tei:pos"/>
      <xs:element ref="tei:subc"/>
  ...
  <xs:group name="model.lexicalRefinement_sequence">
    <xs:sequence>
      <xs:element ref="tei:gramGrp"/>
      <xs:element ref="tei:pos"/>
      <xs:element ref="tei:subc"/>
  ...
  <xs:group name="model.lexicalRefinement_sequenceOptional">
    <xs:sequence>
  ...
  <xs:group name="model.lexicalRefinement_sequenceOptionalRepeatable">
    <xs:sequence>
  ...
  <xs:group name="model.lexicalRefinement_sequenceRepeatable">
    <xs:sequence>
  ...
  <xs:group name="model.gramPart">
    <xs:choice>
      <xs:group ref="tei:model.morphLike"/>
  ...
  <xs:group name="model.ptrLike.form">
    <xs:choice>
      ...
      <xs:element ref="tei:oVar"/>
      <xs:element ref="tei:pRef"/>
      <xs:element ref="tei:pVar"/>
    </xs:choice>
  </xs:group>
  <xs:element name="superEntry">
    ...
    <xs:complexType>
      ...
      <xs:attributeGroup ref="tei:att.global.attributes"/>
      <xs:attributeGroup ref="tei:att.entryLike.attributes"/>
      <xs:attributeGroup ref="tei:att.sortable.attributes"/>
    </xs:complexType>
  </xs:element>
  ...
  <xs:element name="form">
    ...
    <xs:complexType mixed="true">
      <xs:choice minOccurs="0" maxOccurs="unbounded">
        ...
        <xs:group ref="tei:model.phrase"/>
        <xs:group ref="tei:model.inter"/>
        <xs:group ref="tei:model.formPart"/>
        <xs:group ref="tei:model.global"/>
      </xs:choice>
      <xs:attributeGroup ref="tei:att.global.attributes"/>
      <xs:attributeGroup ref="tei:att.lexicographic.attributes"/>
...
Sample values include: 1] abbrev; 2] verbTable</xs:documentation>
  ...
  <xs:element name="gramGrp">
    <xs:annotation>
      <xs:documentation>(grammatical information group) groups morpho-syntactic information about a lexical item, e.g. pos, gen, number, case, or iType (inflectional class). [9.3.2. Grammatical Information]</xs:documentation>
    </xs:annotation>
    <xs:complexType mixed="true">
      <xs:choice minOccurs="0" maxOccurs="unbounded">
        <xs:group ref="tei:model.gLike"/>
...
Sample values include: 1] geo(geographic) ; 2] time; 3] dom(domain) ; 4] register; 5] style; 6] plev(preference level) ; 7] lang(language) ; 8] gram(grammatical) ; 9] syn(synonym) ; 10] hyper(hypernym) ; 11] colloc(collocation) ; 12] comp(complement) ; 13] obj(object) ; 14] subj(subject) ; 15] verb; 16] hint</xs:documentation>
            </xs:annotation>
            <xs:simpleType>
              <xs:restriction base="xs:token">
                <xs:pattern value="(\p{L}|\p{N}|\p{P}|\p{S})+"/>
...
Sample values include: 1] cap(capital) ; 2] noHyph(no hyphen) </xs:documentation>
  ...
  <xs:element name="oVar">
    <xs:annotation>
      <xs:documentation>(orthographic-variant reference) in a dictionary example, indicates a reference to variant orthographic form(s) of the headword. [9. Dictionaries]</xs:documentation>
    </xs:annotation>
    <xs:complexType mixed="true">
      <xs:choice minOccurs="0" maxOccurs="unbounded">
        <xs:group ref="tei:model.gLike"/>
...
Sample values include: 1] pt(past tense) ; 2] pp(past participle) ; 3] prp(present participle) ; 4] f(feminine) ; 5] pl(plural) </xs:documentation>
  ...
  <xs:element name="pVar">
    <xs:annotation>
      <xs:documentation>(pronunciation-variant reference) in a dictionary example, indicates a reference to variant pronunciation(s) of the headword. [9. Dictionaries]</xs:documentation>
    </xs:annotation>
    <xs:complexType mixed="true">
      <xs:choice minOccurs="0" maxOccurs="unbounded">
        <xs:group ref="tei:model.gLike"/>
  ...
  <xs:element name="prologue">
    <xs:annotation>
      <xs:documentation>contains the prologue to a drama, typically spoken by an actor out of character, possibly in association with a particular performance or venue. [7.1.2. Prologues and Epilogues 7.1. Front and Back Matter
 ]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:sequence>
  ...
  <xs:element name="epilogue">
    <xs:annotation>
      <xs:documentation>contains the epilogue to a drama, typically spoken by an actor out of character, possibly in association with a particular performance or venue. [7.1.2. Prologues and Epilogues 7.1. Front and Back Matter
 ]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:sequence>
  ...
  <xs:element name="performance">
    <xs:annotation>
      <xs:documentation>contains a section of front or back matter describing how a dramatic piece is to be performed in general or how it was performed on some specific occasion. [7.1.3. Records of Performances 7.1. Front and Back Matter
 ]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:sequence>
  ...
  <xs:element name="move">
    <xs:annotation>
      <xs:documentation>(movement) marks the actual entrance or exit of one or more characters on stage. [7.2.4. Stage Directions]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:attributeGroup ref="tei:att.global.attributes"/>
      <xs:attributeGroup ref="tei:att.ascribed.attributes"/>
...
Sample values include: 1] L(left) ; 2] R(right) ; 3] C(center) </xs:documentation>
  ...
  <xs:element name="view">
    <xs:annotation>
      <xs:documentation>describes the visual context of some part of a screen play in terms of what the spectator sees, generally independent of any dialogue. [7.3.1. Technical Information 7.3. Other Types of Performance Text]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:complexContent>
        <xs:extension base="tei:macro.specialPara">
  ...
  <xs:element name="camera">
    <xs:annotation>
      <xs:documentation>describes a particular camera angle or viewpoint in a screen play. [7.3.1. Technical Information 7.3. Other Types of Performance Text]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:complexContent>
        <xs:extension base="tei:macro.paraContent">
  ...
  <xs:element name="sound">
    <xs:annotation>
      <xs:documentation>describes a sound effect or musical sequence specified within a screen play or radio script. [7.3.1. Technical Information 7.3. Other Types of Performance Text]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:complexContent>
        <xs:extension base="tei:macro.paraContent">
  ...
  <xs:element name="caption">
    <xs:annotation>
      <xs:documentation>contains the text of a caption or other text displayed as part of a film script or screenplay. [7.3.1. Technical Information 7.3. Other Types of Performance Text]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:complexContent>
        <xs:extension base="tei:macro.paraContent">
  ...
  <xs:element name="tech">
    <xs:annotation>
      <xs:documentation>(technical stage direction) describes a special-purpose stage direction that is not meant for the actors. [7.3.1. Technical Information]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:complexContent>
        <xs:extension base="tei:macro.paraContent">
  ...
  <xs:element name="char">
    ...
    <xs:complexType>
      <xs:sequence>
        <xs:element minOccurs="0" ref="tei:charName"/>
        <xs:group minOccurs="0" maxOccurs="unbounded" ref="tei:model.descLike"/>
        <xs:element minOccurs="0" maxOccurs="unbounded" ref="tei:charProp"/>
        <xs:element minOccurs="0" maxOccurs="unbounded" ref="tei:mapping"/>
        <xs:element minOccurs="0" maxOccurs="unbounded" ref="tei:figure"/>
        <xs:group minOccurs="0" maxOccurs="unbounded" ref="tei:model.graphicLike"/>
        <xs:group minOccurs="0" maxOccurs="unbounded" ref="tei:model.noteLike"/>
      </xs:sequence>
      <xs:attributeGroup ref="tei:att.global.attributes"/>
    </xs:complexType>
  ...
  <xs:element name="glyph">
    ...
    <xs:complexType>
      <xs:sequence>
        <xs:element minOccurs="0" ref="tei:glyphName"/>
        <xs:group minOccurs="0" maxOccurs="unbounded" ref="tei:model.descLike"/>
        <xs:element minOccurs="0" maxOccurs="unbounded" ref="tei:charProp"/>
        <xs:element minOccurs="0" maxOccurs="unbounded" ref="tei:mapping"/>
        <xs:element minOccurs="0" maxOccurs="unbounded" ref="tei:figure"/>
  ...
  <xs:element name="mapping">
    <xs:annotation>
      <xs:documentation>(character mapping) contains one or more characters which are related to the parent character or glyph in some respect, as specified by the type attribute. [5.2. Markup Constructs for Representation of Characters and Glyphs]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:complexContent>
        <xs:extension base="tei:macro.xtext">
...
Sample values include: 1] text; 2] corpus</xs:documentation>
  ...
  <xs:element name="sourceDesc">
    ...
    <xs:complexType>
      <xs:choice>
        ...
        <xs:choice maxOccurs="unbounded">
          <xs:group ref="tei:model.biblLike"/>
          <xs:group ref="tei:model.sourceDescPart"/>
          <xs:group ref="tei:model.listLike"/>
        </xs:choice>
      </xs:choice>
      <xs:attributeGroup ref="tei:att.global.attributes"/>
  ...
  <xs:element name="editorialDecl">
    ...
    <xs:complexType>
      <xs:choice maxOccurs="unbounded">
        <xs:group ref="tei:model.pLike"/>
        <xs:group ref="tei:model.editorialDeclPart"/>
      </xs:choice>
      <xs:attributeGroup ref="tei:att.global.attributes"/>
      <xs:attributeGroup ref="tei:att.declarable.attributes"/>
    </xs:complexType>
...
Sample values include: 1] first-line; 2] first-letter; 3] before; 4] after</xs:documentation>
  ...
  <xs:element name="catDesc">
    ...
    <xs:complexType mixed="true">
      <xs:choice minOccurs="0" maxOccurs="unbounded">
        <xs:group ref="tei:model.limitedPhrase"/>
        <xs:group ref="tei:model.catDescPart"/>
      </xs:choice>
      <xs:attributeGroup ref="tei:att.global.attributes"/>
    </xs:complexType>
  </xs:element>
...
Suggested values include: 1] WGS84(World Geodetic System) ; 2] MGRS(Military Grid Reference System) ; 3] OSGB36(ordnance survey great britain) ; 4] ED50(European Datum coordinate system) </xs:documentation>
  ...
  <xs:element name="handNote">
    <xs:annotation>
      <xs:documentation>(note on hand) describes a particular style or hand distinguished within a manuscript. [10.7.2. Writing, Decoration, and Other Notations]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:complexContent>
        <xs:extension base="tei:macro.specialPara">
          <xs:attributeGroup ref="tei:att.global.attributes"/>
          <xs:attributeGroup ref="tei:att.handFeatures.attributes"/>
        </xs:extension>
      </xs:complexContent>
    </xs:complexType>
  </xs:element>
  ...
  <xs:element name="correspDesc">
    ...
    <xs:complexType>
      <xs:choice>
        <xs:group maxOccurs="unbounded" ref="tei:model.correspDescPart"/>
        <xs:group maxOccurs="unbounded" ref="tei:model.pLike"/>
      </xs:choice>
      <xs:attributeGroup ref="tei:att.declarable.attributes"/>
      <xs:attributeGroup ref="tei:att.canonical.attributes"/>
  ...
  <xs:element name="correspAction">
    ...
    <xs:complexType>
      <xs:choice>
        <xs:group maxOccurs="unbounded" ref="tei:model.correspActionPart"/>
        <xs:group maxOccurs="unbounded" ref="tei:model.pLike"/>
      </xs:choice>
      <xs:attributeGroup ref="tei:att.global.attributes"/>
      <xs:attributeGroup ref="tei:att.typed.attribute.subtype"/>
...
Suggested values include: 1] sent; 2] received; 3] transmitted; 4] redirected; 5] forwarded</xs:documentation>
  ...
  <xs:element name="correspContext">
    ...
    <xs:complexType>
      <xs:group maxOccurs="unbounded" ref="tei:model.correspContextPart"/>
      <xs:attributeGroup ref="tei:att.global.attributes"/>
    </xs:complexType>
  </xs:element>
  <xs:element name="xenoData">
    ...
    <xs:complexType mixed="true">
      <xs:group minOccurs="0" ref="tei:macro.anyXML"/>
      <xs:attributeGroup ref="tei:att.global.attributes"/>
      <xs:attributeGroup ref="tei:att.declarable.attributes"/>
      <xs:attributeGroup ref="tei:att.typed.attributes"/>
    </xs:complexType>
  ...
  <xs:element name="typeNote">
    <xs:annotation>
      <xs:documentation>describes a particular font or other significant typographic feature distinguished within the description of a printed resource. [10.7.2. Writing, Decoration, and Other Notations]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:complexContent>
        <xs:extension base="tei:macro.specialPara">
  ...
  <xs:element name="scriptNote">
    <xs:annotation>
      <xs:documentation>describes a particular script distinguished within the description of a manuscript or similar resource. [10.7.2. Writing, Decoration, and Other Notations]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:complexContent>
        <xs:extension base="tei:macro.specialPara">
  ...
  <xs:element name="fsDecl">
    ...
    <xs:complexType>
      <xs:sequence>
        ...
        <xs:element minOccurs="0" ref="tei:fsConstraints"/>
      </xs:sequence>
      <xs:attributeGroup ref="tei:att.global.attributes"/>
  ...
  <xs:element name="fsdLink">
    <xs:annotation>
      <xs:documentation>(feature structure declaration link) associates the name of a typed feature structure with a feature structure declaration for it. [18.11. Feature System Declaration]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:attributeGroup ref="tei:att.global.attributes"/>
      <xs:attribute name="type" use="required">
  ...
  <xs:element name="vRange">
    ...
    <xs:complexType>
      <xs:group ref="tei:model.featureVal"/>
      <xs:attributeGroup ref="tei:att.global.attributes"/>
    </xs:complexType>
  </xs:element>
  <xs:element name="vDefault">
    ...
    <xs:complexType>
      <xs:choice>
        <xs:group maxOccurs="unbounded" ref="tei:model.featureVal"/>
        <xs:element maxOccurs="unbounded" ref="tei:if"/>
      </xs:choice>
      <xs:attributeGroup ref="tei:att.global.attributes"/>
    </xs:complexType>
  </xs:element>
  <xs:element name="if">
    <xs:annotation>
      <xs:documentation>defines a conditional default value for a feature; the condition is specified as a feature structure, and is met if it subsumes the feature structure in the text for which a default value is sought. [18.11. Feature System Declaration]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:sequence>
        <xs:choice>
  ...
  <xs:element name="then">
    <xs:annotation>
      <xs:documentation>separates the condition from the default in an if, or the antecedent and the consequent in a cond element. [18.11. Feature System Declaration]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:attributeGroup ref="tei:att.global.attributes"/>
    </xs:complexType>
  ...
  <xs:element name="fsConstraints">
    <xs:annotation>
      <xs:documentation>(feature-structure constraints) specifies constraints on the content of valid feature structures. [18.11. Feature System Declaration]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:choice minOccurs="0" maxOccurs="unbounded">
        <xs:element ref="tei:cond"/>
        <xs:element ref="tei:bicond"/>
      </xs:choice>
      <xs:attributeGroup ref="tei:att.global.attributes"/>
    </xs:complexType>
  </xs:element>
  ...
  <xs:element name="iff">
    <xs:annotation>
      <xs:documentation>(if and only if) separates the condition from the consequence in a bicond element. [18.11. Feature System Declaration]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:attributeGroup ref="tei:att.global.attributes"/>
    </xs:complexType>
...
Feature Value]</xs:documentation>
  ...
  <xs:element name="vLabel">
    ...
    <xs:complexType>
      <xs:group minOccurs="0" ref="tei:model.featureVal"/>
      <xs:attributeGroup ref="tei:att.global.attributes"/>
  ...
  <xs:element name="vNot">
    <xs:annotation>
      <xs:documentation>(value negation) represents a feature value which is the negation of its content. [18.8.2. Negation]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:group ref="tei:model.featureVal"/>
      <xs:attributeGroup ref="tei:att.global.attributes"/>
  ...
  <xs:element name="vMerge">
    <xs:annotation>
      <xs:documentation>(merged collection of values) represents a feature value which is the result of merging together the feature values contained by its children, using the organization specified by the org attribute. [18.8.3. Collection of Values]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:group maxOccurs="unbounded" ref="tei:model.featureVal"/>
      <xs:attributeGroup ref="tei:att.global.attributes"/>
  ...
  <xs:element name="fLib">
    <xs:annotation>
      <xs:documentation>(feature library) assembles a library of feature elements. [18.4. Feature Libraries and Feature-Value Libraries]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:sequence>
  ...
  <xs:element name="fvLib">
    ...
    <xs:complexType>
      <xs:group minOccurs="0" maxOccurs="unbounded" ref="tei:model.featureVal"/>
      <xs:attributeGroup ref="tei:att.global.attributes"/>
    </xs:complexType>
  </xs:element>
  ...
  <xs:element name="linkGrp">
    ...
    <xs:complexType>
      ...
      <xs:attributeGroup ref="tei:att.global.attributes"/>
      <xs:attributeGroup ref="tei:att.pointing.group.attributes"/>
    </xs:complexType>
  </xs:element>
  <xs:element name="ab">
    <xs:annotation>
  ...
  <xs:element name="anchor">
    <xs:annotation>
      <xs:documentation>(anchor point) attaches an identifier to a point within a text, whether or not it corresponds with a textual element. [8.4.2. Synchronization and Overlap 16.4. Correspondence and Alignment]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:attributeGroup ref="tei:att.global.attributes"/>
      <xs:attributeGroup ref="tei:att.typed.attributes"/>
  ...
  <xs:element name="when">
    <xs:annotation>
      <xs:documentation>indicates a point in time either relative to other elements in the same timeline tag, or absolutely. [16.5.2. Placing Synchronous Events in Time]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:attributeGroup ref="tei:att.global.attributes"/>
...
Suggested values include: 1] d(days) ; 2] h(hours) ; 3] min(minutes) ; 4] s(seconds) ; 5] ms(milliseconds) </xs:documentation>
  ...
  <xs:element name="joinGrp">
    <xs:annotation>
      <xs:documentation>(join group) groups a collection of join elements and possibly pointers. [16.7. Aggregation]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:sequence>
        <xs:group minOccurs="0" maxOccurs="unbounded" ref="tei:model.glossLike"/>
        <xs:choice maxOccurs="unbounded">
          <xs:element ref="tei:join"/>
          <xs:element ref="tei:ptr"/>
        </xs:choice>
      ...
      <xs:attribute name="result" type="xs:Name">
        <xs:annotation>
          <xs:documentation>supplies the default value for the result on each join included within the group.</xs:documentation>
        </xs:annotation>
      </xs:attribute>
    </xs:complexType>
  </xs:element>
  ...
  <xs:element name="altGrp">
    <xs:annotation>
      <xs:documentation>(alternation group) groups a collection of alt elements and possibly pointers. [16.8. Alternation]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:choice minOccurs="0" maxOccurs="unbounded">
        <xs:element ref="tei:alt"/>
    ...
    <xs:complexType>
      <xs:sequence>
        ...
        <xs:choice>
          <xs:group maxOccurs="unbounded" ref="tei:model.pLike"/>
          <xs:sequence>
            <xs:element minOccurs="0" ref="tei:msContents"/>
            <xs:element minOccurs="0" ref="tei:physDesc"/>
            <xs:element minOccurs="0" ref="tei:history"/>
            <xs:element minOccurs="0" ref="tei:additional"/>
            <xs:choice>
              <xs:element minOccurs="0" maxOccurs="unbounded" ref="tei:msPart"/>
              <xs:element minOccurs="0" maxOccurs="unbounded" ref="tei:msFrag"/>
            </xs:choice>
          </xs:sequence>
        </xs:choice>
      </xs:sequence>
  ...
  <xs:element name="catchwords">
    <xs:annotation>
      <xs:documentation>describes the system used to ensure correct ordering of the quires making up a codex or incunable, typically by means of annotations at the foot of the page. [10.3.7. Catchwords, Signatures, Secundo Folio]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:complexContent>
        <xs:extension base="tei:macro.phraseSeq">
  ...
  <xs:element name="dimensions">
    <xs:annotation>
      <xs:documentation>contains a dimensional specification. [10.3.4. Dimensions]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:choice minOccurs="0" maxOccurs="unbounded">
        <xs:element ref="tei:dim"/>
        <xs:group ref="tei:model.dimLike"/>
      </xs:choice>
      <xs:attributeGroup ref="tei:att.global.attributes"/>
      <xs:attributeGroup ref="tei:att.dimensions.attributes"/>
      <xs:attribute name="type">
...
Sample values include: 1] leaves; 2] ruled; 3] pricked; 4] written; 5] miniatures; 6] binding; 7] box</xs:documentation>
  ...
  <xs:element name="dim">
    <xs:annotation>
      <xs:documentation>contains any single measurement forming part of a dimensional specification of some sort. [10.3.4. Dimensions]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:complexContent>
        <xs:extension base="tei:macro.xtext">
  ...
  <xs:element name="height">
    <xs:annotation>
      <xs:documentation>contains a measurement measured along the axis at right angles to the bottom of the written surface, i.e. parallel to the spine for a codex or book. [10.3.4. Dimensions]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:complexContent>
        <xs:extension base="tei:macro.xtext">
  ...
  <xs:element name="depth">
    <xs:annotation>
      <xs:documentation>contains a measurement measured across the spine of a book or codex, or (for other text-bearing objects) perpendicular to the measurement given by the width element. [10.3.4. Dimensions]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:complexContent>
        <xs:extension base="tei:macro.xtext">
  ...
  <xs:element name="width">
    <xs:annotation>
      <xs:documentation>contains a measurement measured along the axis parallel to the bottom of the written surface, i.e. perpendicular to the spine of a book or codex. [10.3.4. Dimensions]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:complexContent>
        <xs:extension base="tei:macro.xtext">
  ...
  <xs:element name="heraldry">
    <xs:annotation>
      <xs:documentation>contains a heraldic formula or phrase, typically found as part of a blazon, coat of arms, etc.  [10.3.8. Heraldry]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:complexContent>
        <xs:extension base="tei:macro.phraseSeq">
  ...
  <xs:element name="locus">
    <xs:annotation>
      <xs:documentation>defines a location within a manuscript or manuscript part, usually as a (possibly discontinuous) sequence of folio references. [10.3.5. References to Locations within a Manuscript]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:complexContent>
        <xs:extension base="tei:macro.xtext">
          ...
          <xs:attribute name="scheme" type="xs:anyURI">
            <xs:annotation>
              <xs:documentation>identifies the foliation scheme in terms of which the location is being specified by pointing to some foliation element defining it, or to some other equivalent resource.</xs:documentation>
            </xs:annotation>
          </xs:attribute>
          <xs:attribute name="from">
            <xs:annotation>
              <xs:documentation>specifies the starting point of the location in a normalized form, typically a page number.</xs:documentation>
            </xs:annotation>
            <xs:simpleType>
              <xs:restriction base="xs:token">
                <xs:pattern value="(\p{L}|\p{N}|\p{P}|\p{S})+"/>
          ...
          <xs:attribute name="to">
            <xs:annotation>
              <xs:documentation>specifies the end-point of the location in a normalized form, typically as a page number.</xs:documentation>
            </xs:annotation>
            <xs:simpleType>
              <xs:restriction base="xs:token">
                <xs:pattern value="(\p{L}|\p{N}|\p{P}|\p{S})+"/>
  ...
  <xs:element name="locusGrp">
    <xs:annotation>
      <xs:documentation>groups a number of locations which together form a distinct but discontinuous item within a manuscript or manuscript part, according to a specific foliation. [10.3.5. References to Locations within a Manuscript]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:sequence>
        <xs:element maxOccurs="unbounded" ref="tei:locus"/>
      </xs:sequence>
      <xs:attributeGroup ref="tei:att.global.attributes"/>
      <xs:attribute name="scheme" type="xs:anyURI">
        <xs:annotation>
          <xs:documentation>identifies the foliation scheme in terms of which all the locations contained by the group are specified by pointing to some foliation element defining it, or to some other equivalent resource.</xs:documentation>
        </xs:annotation>
      </xs:attribute>
    </xs:complexType>
  </xs:element>
  <xs:element name="material">
    <xs:annotation>
      <xs:documentation>contains a word or phrase describing the material of which the object being described is composed. [10.3.2. Material and Object Type]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:complexContent>
        <xs:extension base="tei:macro.phraseSeq">
  ...
  <xs:element name="objectType">
    <xs:annotation>
      <xs:documentation>contains a word or phrase describing the type of object being referred to. [10.3.2. Material and Object Type]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:complexContent>
        <xs:extension base="tei:macro.phraseSeq">
  ...
  <xs:element name="origDate">
    <xs:annotation>
      <xs:documentation>(origin date) contains any form of date, used to identify the date of origin for a manuscript or manuscript part. [10.3.1. Origination]</xs:documentation>
    </xs:annotation>
    <xs:complexType mixed="true">
      <xs:choice minOccurs="0" maxOccurs="unbounded">
        <xs:group ref="tei:model.gLike"/>
  ...
  <xs:element name="origPlace">
    <xs:annotation>
      <xs:documentation>(origin place) contains any form of place name, used to identify the place of origin for a manuscript or manuscript part. [10.3.1. Origination]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:complexContent>
        <xs:extension base="tei:macro.phraseSeq">
  ...
  <xs:element name="secFol">
    <xs:annotation>
      <xs:documentation>(second folio) marks the word or words taken from a fixed point in a codex (typically the beginning of the second leaf) in order to provide a unique identifier for it.  [10.3.7. Catchwords, Signatures, Secundo Folio]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:complexContent>
        <xs:extension base="tei:macro.phraseSeq">
  ...
  <xs:element name="signatures">
    <xs:annotation>
      <xs:documentation>contains discussion of the leaf or quire signatures found within a codex. [10.3.7. Catchwords, Signatures, Secundo Folio]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:complexContent>
        <xs:extension base="tei:macro.specialPara">
  ...
  <xs:element name="stamp">
    <xs:annotation>
      <xs:documentation>contains a word or phrase describing a stamp or similar device. [10.3.3. Watermarks and Stamps]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:complexContent>
        <xs:extension base="tei:macro.phraseSeq">
  ...
  <xs:element name="watermark">
    <xs:annotation>
      <xs:documentation>contains a word or phrase describing a watermark or similar device. [10.3.3. Watermarks and Stamps]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:complexContent>
        <xs:extension base="tei:macro.phraseSeq">
  ...
  <xs:element name="msIdentifier">
    <xs:annotation>
      <xs:documentation>(manuscript identifier) contains the information required to identify the manuscript being described. [10.4. The Manuscript Identifier]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:sequence>
        <xs:sequence>
  ...
  <xs:element name="institution">
    <xs:annotation>
      <xs:documentation>contains the name of an organization such as a university or library, with which a manuscript is identified, generally its holding institution. [10.4. The Manuscript Identifier]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:complexContent>
        <xs:extension base="tei:macro.xtext">
  ...
  <xs:element name="repository">
    <xs:annotation>
      <xs:documentation>contains the name of a repository within which manuscripts are stored, possibly forming part of an institution. [10.4. The Manuscript Identifier]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:complexContent>
        <xs:extension base="tei:macro.xtext">
  ...
  <xs:element name="collection">
    <xs:annotation>
      <xs:documentation>contains the name of a collection of manuscripts, not necessarily located within a single repository. [10.4. The Manuscript Identifier]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:complexContent>
        <xs:extension base="tei:macro.xtext">
  ...
  <xs:element name="altIdentifier">
    <xs:annotation>
      <xs:documentation>(alternative identifier) contains an alternative or former structured identifier used for a manuscript, such as a former catalogue number. [10.4. The Manuscript Identifier]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:sequence>
        <xs:element minOccurs="0" ref="tei:placeName"/>
  ...
  <xs:element name="msName">
    <xs:annotation>
      <xs:documentation>(alternative name) contains any form of unstructured alternative name used for a manuscript, such as an ocellus nominum, or nickname. [10.4. The Manuscript Identifier]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:complexContent>
        <xs:extension base="tei:macro.xtext">
  ...
  <xs:element name="colophon">
    <xs:annotation>
      <xs:documentation>contains the colophon of a manuscript item: that is, a statement providing information regarding the date, place, agency, or reason for production of the manuscript. [10.6.1. The msItem and msItemStruct Elements]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:complexContent>
        <xs:extension base="tei:macro.phraseSeq">
  ...
  <xs:element name="explicit">
    <xs:annotation>
      <xs:documentation>contains the explicit of a manuscript item, that is, the closing words of the text proper, exclusive of any rubric or colophon which might follow it. [10.6.1. The msItem and msItemStruct Elements]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:complexContent>
        <xs:extension base="tei:macro.phraseSeq">
  ...
  <xs:element name="filiation">
    <xs:annotation>
      <xs:documentation>contains information concerning the manuscript's filiation, i.e. its relationship to other surviving manuscripts of the same text, its protographs, antigraphs and apographs. [10.6.1. The msItem and msItemStruct Elements]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:complexContent>
        <xs:extension base="tei:macro.specialPara">
  ...
  <xs:element name="finalRubric">
    <xs:annotation>
      <xs:documentation>contains the string of words that denotes the end of a text division, often with an assertion as to its author and title, usually set off from the text itself by red ink, by a different size or type of script, or by some other such visual device. [10.6.1. The msItem and msItemStruct Elements]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:complexContent>
        <xs:extension base="tei:macro.phraseSeq">
  ...
  <xs:element name="incipit">
    <xs:annotation>
      <xs:documentation>contains the incipit of a manuscript item, that is the opening words of the text proper, exclusive of any rubric which might precede it, of sufficient length to identify the work uniquely; such incipits were, in former times, frequently used a means of reference to a work, in place of a title. [10.6.1. The msItem and msItemStruct Elements]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:complexContent>
        <xs:extension base="tei:macro.phraseSeq">
  ...
  <xs:element name="msContents">
    <xs:annotation>
      <xs:documentation>(manuscript contents) describes the intellectual content of a manuscript or manuscript part, either as a series of paragraphs or as a series of structured manuscript items. [10.6. Intellectual Content]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:choice>
        <xs:group maxOccurs="unbounded" ref="tei:model.pLike"/>
        <xs:sequence>
          ...
          <xs:element minOccurs="0" ref="tei:titlePage"/>
          <xs:choice minOccurs="0" maxOccurs="unbounded">
            <xs:element ref="tei:msItem"/>
            <xs:element ref="tei:msItemStruct"/>
          </xs:choice>
      ...
      <xs:attribute name="class">
        <xs:annotation>
          <xs:documentation>identifies the text types or classifications applicable to this object by pointing to other elements or resources defining the classification concerned. </xs:documentation>
        </xs:annotation>
        <xs:simpleType>
          <xs:restriction>
            <xs:simpleType>
  ...
  <xs:element name="msItem">
    <xs:annotation>
      <xs:documentation>(manuscript item) describes an individual work or item within the intellectual content of a manuscript or manuscript part. [10.6.1. The msItem and msItemStruct Elements]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:sequence>
        <xs:choice minOccurs="0" maxOccurs="unbounded">
        ...
        <xs:choice>
          ...
          <xs:choice maxOccurs="unbounded">
            ...
            <xs:group ref="tei:model.msItemPart"/>
            <xs:group ref="tei:model.global"/>
          </xs:choice>
        </xs:choice>
      </xs:sequence>
      ...
      <xs:attribute name="class">
        <xs:annotation>
          <xs:documentation>identifies the text types or classifications applicable to this item by pointing to other elements or resources defining the classification concerned. </xs:documentation>
        </xs:annotation>
        <xs:simpleType>
          <xs:restriction>
            <xs:simpleType>
  ...
  <xs:element name="msItemStruct">
    <xs:annotation>
      <xs:documentation>(structured manuscript item) contains a structured description for an individual work or item within the intellectual content of a manuscript or manuscript part. [10.6.1. The msItem and msItemStruct Elements]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:sequence>
        <xs:choice minOccurs="0">
        ...
        <xs:choice>
          ...
          <xs:sequence>
            ...
            <xs:element minOccurs="0" maxOccurs="unbounded" ref="tei:respStmt"/>
            <xs:element minOccurs="0" maxOccurs="unbounded" ref="tei:title"/>
            <xs:element minOccurs="0" ref="tei:rubric"/>
            <xs:element minOccurs="0" ref="tei:incipit"/>
            <xs:element minOccurs="0" maxOccurs="unbounded" ref="tei:msItemStruct"/>
            <xs:element minOccurs="0" ref="tei:explicit"/>
            <xs:element minOccurs="0" ref="tei:finalRubric"/>
            <xs:element minOccurs="0" maxOccurs="unbounded" ref="tei:colophon"/>
            <xs:element minOccurs="0" maxOccurs="unbounded" ref="tei:decoNote"/>
            <xs:element minOccurs="0" maxOccurs="unbounded" ref="tei:listBibl"/>
            <xs:choice minOccurs="0" maxOccurs="unbounded">
              <xs:element ref="tei:bibl"/>
              <xs:element ref="tei:biblStruct"/>
  ...
  <xs:element name="summary">
    <xs:annotation>
      <xs:documentation>contains an overview of the available information concerning some aspect of an item (for example, its intellectual content, history, layout, typography etc.) as a complement or alternative to the more detailed information carried by more specific elements. [10.6. Intellectual Content]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:complexContent>
        <xs:extension base="tei:macro.specialPara">
  ...
  <xs:element name="physDesc">
    <xs:annotation>
      <xs:documentation>(physical description) contains a full physical description of a manuscript or manuscript part, optionally subdivided using more specialized elements from the model.physDescPart class. [10.7. Physical Description]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:sequence>
        <xs:group minOccurs="0" maxOccurs="unbounded" ref="tei:model.pLike"/>
        <xs:element minOccurs="0" ref="tei:objectDesc"/>
        <xs:element minOccurs="0" ref="tei:handDesc"/>
        <xs:element minOccurs="0" ref="tei:typeDesc"/>
        <xs:element minOccurs="0" ref="tei:scriptDesc"/>
        <xs:element minOccurs="0" ref="tei:musicNotation"/>
        <xs:element minOccurs="0" ref="tei:decoDesc"/>
        <xs:element minOccurs="0" ref="tei:additions"/>
        <xs:element minOccurs="0" ref="tei:bindingDesc"/>
        <xs:element minOccurs="0" ref="tei:sealDesc"/>
        <xs:element minOccurs="0" ref="tei:accMat"/>
      </xs:sequence>
      <xs:attributeGroup ref="tei:att.global.attributes"/>
    </xs:complexType>
  </xs:element>
  <xs:element name="objectDesc">
    <xs:annotation>
      <xs:documentation>contains a description of the physical components making up the object which is being described. [10.7.1. Object Description]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:choice>
        <xs:group maxOccurs="unbounded" ref="tei:model.pLike"/>
        <xs:sequence>
          ...
          <xs:element minOccurs="0" ref="tei:layoutDesc"/>
        </xs:sequence>
      </xs:choice>
      <xs:attributeGroup ref="tei:att.global.attributes"/>
  ...
  <xs:element name="supportDesc">
    <xs:annotation>
      <xs:documentation>(support description) groups elements describing the physical support for the written part of a manuscript. [10.7.1. Object Description]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:choice>
        <xs:group maxOccurs="unbounded" ref="tei:model.pLike"/>
        <xs:sequence>
          <xs:element minOccurs="0" ref="tei:support"/>
          <xs:element minOccurs="0" ref="tei:extent"/>
          <xs:element minOccurs="0" maxOccurs="unbounded" ref="tei:foliation"/>
...
Suggested values include: 1] paper; 2] parch(parchment) ; 3] mixed</xs:documentation>
  ...
  <xs:element name="support">
    <xs:annotation>
      <xs:documentation>contains a description of the materials etc. which make up the physical support for the written part of a manuscript. [10.7.1. Object Description]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:complexContent>
        <xs:extension base="tei:macro.specialPara">
  ...
  <xs:element name="collation">
    <xs:annotation>
      <xs:documentation>contains a description of how the leaves or bifolia are physically arranged. [10.7.1. Object Description]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:complexContent>
        <xs:extension base="tei:macro.specialPara">
  ...
  <xs:element name="foliation">
    <xs:annotation>
      <xs:documentation>describes the numbering system or systems used to count the leaves or pages in a codex. [10.7.1.4. Foliation]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:complexContent>
        <xs:extension base="tei:macro.specialPara">
  ...
  <xs:element name="condition">
    <xs:annotation>
      <xs:documentation>contains a description of the physical condition of the manuscript. [10.7.1.5. Condition]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:complexContent>
        <xs:extension base="tei:macro.specialPara">
  ...
  <xs:element name="layoutDesc">
    <xs:annotation>
      <xs:documentation>(layout description) collects the set of layout descriptions applicable to a manuscript. [10.7.2. Writing, Decoration, and Other Notations]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:choice>
        <xs:group maxOccurs="unbounded" ref="tei:model.pLike"/>
        <xs:sequence>
          <xs:element minOccurs="0" ref="tei:summary"/>
          <xs:element maxOccurs="unbounded" ref="tei:layout"/>
        </xs:sequence>
      </xs:choice>
      <xs:attributeGroup ref="tei:att.global.attributes"/>
    </xs:complexType>
  ...
  <xs:element name="layout">
    <xs:annotation>
      <xs:documentation>describes how text is laid out on the page, including information about any ruling, pricking, or other evidence of page-preparation techniques. [10.7.2. Writing, Decoration, and Other Notations]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:complexContent>
        <xs:extension base="tei:macro.specialPara">
  ...
  <xs:element name="handDesc">
    <xs:annotation>
      <xs:documentation>(description of hands) contains a description of all the different kinds of writing used in a manuscript. [10.7.2. Writing, Decoration, and Other Notations]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:choice>
        <xs:group maxOccurs="unbounded" ref="tei:model.pLike"/>
        <xs:sequence>
          <xs:element minOccurs="0" ref="tei:summary"/>
          <xs:element maxOccurs="unbounded" ref="tei:handNote"/>
        </xs:sequence>
      </xs:choice>
      <xs:attributeGroup ref="tei:att.global.attributes"/>
  ...
  <xs:element name="typeDesc">
    ...
    <xs:complexType>
      <xs:choice>
        ...
        <xs:sequence>
          <xs:element minOccurs="0" ref="tei:summary"/>
          <xs:element maxOccurs="unbounded" ref="tei:typeNote"/>
        </xs:sequence>
      </xs:choice>
      <xs:attributeGroup ref="tei:att.global.attributes"/>
    </xs:complexType>
  ...
  <xs:element name="scriptDesc">
    <xs:annotation>
      <xs:documentation>contains a description of the scripts used in a manuscript or similar source. [10.7.2.1. Writing]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:choice>
        <xs:group maxOccurs="unbounded" ref="tei:model.pLike"/>
        <xs:sequence>
          <xs:element minOccurs="0" ref="tei:summary"/>
          <xs:element maxOccurs="unbounded" ref="tei:scriptNote"/>
        </xs:sequence>
      </xs:choice>
      <xs:attributeGroup ref="tei:att.global.attributes"/>
    </xs:complexType>
  ...
  <xs:element name="musicNotation">
    <xs:annotation>
      <xs:documentation>contains description of type of musical notation. [10.7.2. Writing, Decoration, and Other Notations]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:complexContent>
        <xs:extension base="tei:macro.specialPara">
  ...
  <xs:element name="decoDesc">
    <xs:annotation>
      <xs:documentation>(decoration description) contains a description of the decoration of a manuscript, either as a sequence of paragraphs, or as a sequence of topically organized decoNote elements. [10.7.3. Bindings, Seals, and Additional Material]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:choice>
        <xs:group maxOccurs="unbounded" ref="tei:model.pLike"/>
        <xs:sequence>
          <xs:element minOccurs="0" ref="tei:summary"/>
          <xs:element maxOccurs="unbounded" ref="tei:decoNote"/>
        </xs:sequence>
      </xs:choice>
      <xs:attributeGroup ref="tei:att.global.attributes"/>
    </xs:complexType>
  ...
  <xs:element name="decoNote">
    <xs:annotation>
      <xs:documentation>(note on decoration) contains a note describing either a decorative component of a manuscript, or a fairly homogenous class of such components. [10.7.3. Bindings, Seals, and Additional Material]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:complexContent>
        <xs:extension base="tei:macro.specialPara">
  ...
  <xs:element name="additions">
    <xs:annotation>
      <xs:documentation>contains a description of any significant additions found within a manuscript, such as marginalia or other annotations. [10.7.2. Writing, Decoration, and Other Notations]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:complexContent>
        <xs:extension base="tei:macro.specialPara">
  ...
  <xs:element name="bindingDesc">
    <xs:annotation>
      <xs:documentation>(binding description) describes the present and former bindings of a manuscript, either as a series of paragraphs or as a series of distinct binding elements, one for each binding of the manuscript. [10.7.3.1. Binding Descriptions]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:choice>
        <xs:choice maxOccurs="unbounded">
        ...
        <xs:element maxOccurs="unbounded" ref="tei:binding"/>
      </xs:choice>
      <xs:attributeGroup ref="tei:att.global.attributes"/>
    </xs:complexType>
  </xs:element>
  <xs:element name="binding">
    <xs:annotation>
      <xs:documentation>contains a description of one binding, i.e. type of covering, boards, etc. applied to a manuscript. [10.7.3.1. Binding Descriptions]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:choice maxOccurs="unbounded">
        <xs:group ref="tei:model.pLike"/>
  ...
  <xs:element name="sealDesc">
    <xs:annotation>
      <xs:documentation>(seal description) describes the seals or other external items attached to a manuscript, either as a series of paragraphs or as a series of distinct seal elements, possibly with additional decoNotes. [10.7.3.2. Seals]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:choice>
        <xs:group maxOccurs="unbounded" ref="tei:model.pLike"/>
  ...
  <xs:element name="seal">
    <xs:annotation>
      <xs:documentation>contains a description of one seal or similar attachment applied to a manuscript. [10.7.3.2. Seals]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:choice maxOccurs="unbounded">
        <xs:group ref="tei:model.pLike"/>
  ...
  <xs:element name="history">
    <xs:annotation>
      <xs:documentation>groups elements describing the full history of a manuscript or manuscript part. [10.8. History]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:choice>
        <xs:group maxOccurs="unbounded" ref="tei:model.pLike"/>
  ...
  <xs:element name="origin">
    <xs:annotation>
      <xs:documentation>contains any descriptive or other information concerning the origin of a manuscript or manuscript part. [10.8. History]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:complexContent>
        <xs:extension base="tei:macro.specialPara">
  ...
  <xs:element name="provenance">
    <xs:annotation>
      <xs:documentation>contains any descriptive or other information concerning a single identifiable episode during the history of a manuscript or manuscript part, after its creation but before its acquisition. [10.8. History]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:complexContent>
        <xs:extension base="tei:macro.specialPara">
  ...
  <xs:element name="acquisition">
    <xs:annotation>
      <xs:documentation>contains any descriptive or other information concerning the process by which a manuscript or manuscript part entered the holding institution. [10.8. History]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:complexContent>
        <xs:extension base="tei:macro.specialPara">
  ...
  <xs:element name="additional">
    <xs:annotation>
      <xs:documentation>groups additional information, combining bibliographic information about a manuscript, or surrogate copies of it with curatorial or administrative information. [10.9. Additional Information]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:sequence>
        <xs:element minOccurs="0" ref="tei:adminInfo"/>
        <xs:element minOccurs="0" ref="tei:surrogates"/>
        <xs:element minOccurs="0" ref="tei:listBibl"/>
      </xs:sequence>
      <xs:attributeGroup ref="tei:att.global.attributes"/>
    </xs:complexType>
  ...
  <xs:element name="adminInfo">
    <xs:annotation>
      <xs:documentation>(administrative information) contains information about the present custody and availability of the manuscript, and also about the record description itself. [10.9.1. Administrative Information]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:sequence>
        <xs:element minOccurs="0" ref="tei:recordHist"/>
        <xs:element minOccurs="0" ref="tei:availability"/>
        <xs:element minOccurs="0" ref="tei:custodialHist"/>
        <xs:group minOccurs="0" ref="tei:model.noteLike"/>
      </xs:sequence>
      <xs:attributeGroup ref="tei:att.global.attributes"/>
    </xs:complexType>
  </xs:element>
  <xs:element name="recordHist">
    <xs:annotation>
      <xs:documentation>(recorded history) provides information about the source and revision status of the parent manuscript description itself. [10.9.1. Administrative Information]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:choice>
        <xs:group maxOccurs="unbounded" ref="tei:model.pLike"/>
  ...
  <xs:element name="source">
    <xs:annotation>
      <xs:documentation>describes the original source for the information contained with a manuscript description. [10.9.1.1. Record History]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:complexContent>
        <xs:extension base="tei:macro.specialPara">
  ...
  <xs:element name="custodialHist">
    <xs:annotation>
      <xs:documentation>(custodial history) contains a description of a manuscript's custodial history, either as running prose or as a series of dated custodial events. [10.9.1.2. Availability and Custodial History]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:choice>
        <xs:group maxOccurs="unbounded" ref="tei:model.pLike"/>
        <xs:element maxOccurs="unbounded" ref="tei:custEvent"/>
      </xs:choice>
      <xs:attributeGroup ref="tei:att.global.attributes"/>
    </xs:complexType>
  </xs:element>
  <xs:element name="custEvent">
    <xs:annotation>
      <xs:documentation>(custodial event) describes a single event during the custodial history of a manuscript. [10.9.1.2. Availability and Custodial History]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:complexContent>
        <xs:extension base="tei:macro.specialPara">
  ...
  <xs:element name="surrogates">
    <xs:annotation>
      <xs:documentation>contains information about any representations of the manuscript being described which may exist in the holding institution or elsewhere. [10.9. Additional Information]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:complexContent>
        <xs:extension base="tei:macro.specialPara">
  ...
  <xs:element name="msPart">
    <xs:annotation>
      <xs:documentation>(manuscript part) contains information about an originally distinct manuscript or part of a manuscript, which is now part of a composite manuscript. [10.10. Manuscript Parts]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:sequence>
        <xs:choice>
  ...
  <xs:element name="msFrag">
    <xs:annotation>
      <xs:documentation>(manuscript fragment) contains information about a fragment of a scattered manuscript now held as a single unit or bound into a larger manuscript. [10.11. Manuscript Fragments]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:sequence>
        <xs:choice>
  ...
  <xs:element name="climate">
    ...
    <xs:complexType>
      <xs:sequence>
        <xs:element minOccurs="0" maxOccurs="unbounded" ref="tei:precision"/>
        <xs:group minOccurs="0" maxOccurs="unbounded" ref="tei:model.headLike"/>
        <xs:choice>
          <xs:group maxOccurs="unbounded" ref="tei:model.pLike"/>
          <xs:group maxOccurs="unbounded" ref="tei:model.labelLike"/>
  ...
  <xs:element name="langKnowledge">
    <xs:annotation>
      <xs:documentation>(language knowledge) summarizes the state of a person's linguistic knowledge, either as prose or by a list of langKnown elements. [13.3.2.1. Personal Characteristics]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:sequence>
        <xs:element minOccurs="0" maxOccurs="unbounded" ref="tei:precision"/>
    ...
    <xs:complexType>
      <xs:complexContent>
        <xs:extension base="tei:macro.phraseSeq">
          ...
          <xs:attribute name="scheme" type="xs:anyURI">
            <xs:annotation>
              <xs:documentation>indicates the classification system or taxonomy in use, for example by supplying the identifier of a taxonomy element, or pointing to some other resource.</xs:documentation>
            </xs:annotation>
          </xs:attribute>
  ...
  <xs:element name="org">
    <xs:annotation>
      <xs:documentation>(organization) provides information about an identifiable organization such as a business, a tribe, or any other grouping of people. [13.2.2. Organizational Names]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:sequence>
        <xs:group minOccurs="0" maxOccurs="unbounded" ref="tei:model.headLike"/>
        <xs:choice>
          ...
          <xs:choice minOccurs="0" maxOccurs="unbounded">
            ...
            <xs:group ref="tei:model.nameLike"/>
            <xs:group ref="tei:model.placeLike"/>
            <xs:group ref="tei:model.orgPart"/>
            <xs:group ref="tei:model.milestoneLike"/>
          </xs:choice>
        </xs:choice>
        <xs:choice minOccurs="0" maxOccurs="unbounded">
    ...
    <xs:complexType>
      <xs:complexContent>
        <xs:extension base="tei:macro.phraseSeq">
          ...
          <xs:attribute name="scheme" type="xs:anyURI">
            <xs:annotation>
              <xs:documentation>identifies the classification system or taxonomy in use, for example by pointing to a locally-defined taxonomy element or by supplying a URI for an externally-defined system.</xs:documentation>
            </xs:annotation>
          </xs:attribute>
          <xs:attribute name="code" type="xs:anyURI">
            <xs:annotation>
  ...
  <xs:element name="nym">
    <xs:annotation>
      <xs:documentation>(canonical name) contains the definition for a canonical name or name component of any kind. [13.3.5. Names and Nyms]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:sequence>
        <xs:group minOccurs="0" maxOccurs="unbounded" ref="tei:model.entryPart"/>
        <xs:group minOccurs="0" maxOccurs="unbounded" ref="tei:model.pLike"/>
  ...
  <xs:element name="listNym">
    <xs:annotation>
      <xs:documentation>(list of canonical names) contains a list of nyms, that is, standardized names for any thing. [13.3.5. Names and Nyms]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:sequence>
        <xs:group minOccurs="0" maxOccurs="unbounded" ref="tei:model.headLike"/>
  ...
  <xs:element name="graph">
    <xs:annotation>
      <xs:documentation>encodes a graph, which is a collection of nodes, and arcs which connect the nodes. [19.1. Graphs and Digraphs]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:sequence>
        <xs:sequence minOccurs="0">
        ...
        <xs:choice>
          <xs:sequence>
            <xs:sequence maxOccurs="unbounded">
              <xs:element ref="tei:node"/>
              <xs:group minOccurs="0" maxOccurs="unbounded" ref="tei:model.global"/>
            </xs:sequence>
            <xs:sequence minOccurs="0" maxOccurs="unbounded">
              <xs:element ref="tei:arc"/>
              <xs:group minOccurs="0" maxOccurs="unbounded" ref="tei:model.global"/>
            </xs:sequence>
          </xs:sequence>
          <xs:sequence>
...
Suggested values include: 1] initial; 2] final</xs:documentation>
  ...
  <xs:element name="arc">
    <xs:annotation>
      <xs:documentation>encodes an arc, the connection from one node to another in a graph. [19.1. Graphs and Digraphs]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:sequence minOccurs="0">
        <xs:element ref="tei:label"/>
      ...
      <xs:attribute name="to" use="required" type="xs:anyURI">
        <xs:annotation>
  ...
  <xs:element name="root">
    <xs:annotation>
      <xs:documentation>(root node) represents the root node of a tree. [19.2. Trees]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:sequence>
        <xs:element minOccurs="0" ref="tei:label"/>
      ...
      <xs:attribute name="value" type="xs:anyURI">
        <xs:annotation>
          <xs:documentation>identifies the root node of the network by pointing to a feature structure or other analytic element.</xs:documentation>
        </xs:annotation>
      </xs:attribute>
  ...
  <xs:element name="iNode">
    <xs:annotation>
      <xs:documentation>(intermediate (or internal) node) represents an intermediate (or internal) node of a tree. [19.2. Trees]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:sequence>
        <xs:element minOccurs="0" ref="tei:label"/>
      ...
      <xs:attribute name="value" type="xs:anyURI">
        <xs:annotation>
          <xs:documentation>indicates an intermediate node, which is a feature structure or other analytic element.</xs:documentation>
        </xs:annotation>
      </xs:attribute>
      <xs:attribute name="children" use="required">
        <xs:annotation>
      ...
      <xs:attribute name="follow" type="xs:anyURI">
        <xs:annotation>
          <xs:documentation>provides the identifier of an element which this node follows.</xs:documentation>
        </xs:annotation>
      </xs:attribute>
      <xs:attribute name="outDegree" type="xs:nonNegativeInteger">
        <xs:annotation>
  ...
  <xs:element name="leaf">
    <xs:annotation>
      <xs:documentation>encodes the leaves (terminal nodes) of a tree. [19.2. Trees]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:sequence>
        <xs:element minOccurs="0" ref="tei:label"/>
  ...
  <xs:element name="eTree">
    <xs:annotation>
      <xs:documentation>(embedding tree) provides an alternative to tree element for representing ordered rooted tree structures. [19.3. Another Tree Notation]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:sequence>
        <xs:element minOccurs="0" ref="tei:label"/>
        <xs:choice minOccurs="0" maxOccurs="unbounded">
          <xs:element ref="tei:eTree"/>
          <xs:element ref="tei:triangle"/>
          <xs:element ref="tei:eLeaf"/>
          <xs:group ref="tei:model.ptrLike"/>
        </xs:choice>
      </xs:sequence>
      <xs:attributeGroup ref="tei:att.global.attributes"/>
  ...
  characteristic shape when drawn) provides for an underspecified eTree, that is, an eTree with information left out. [19.3. Another Tree Notation]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:sequence>
        <xs:element minOccurs="0" ref="tei:label"/>
      ...
      <xs:attribute name="value" type="xs:anyURI">
        <xs:annotation>
          <xs:documentation>supplies a value for the triangle, in the form of the identifier of a feature structure or other analytic element.</xs:documentation>
        </xs:annotation>
      </xs:attribute>
    </xs:complexType>
  </xs:element>
  <xs:element name="eLeaf">
    <xs:annotation>
      <xs:documentation>(leaf or terminal node of an embedding tree) provides explicitly for a leaf of an embedding tree, which may also be encoded with the eTree element. [19.3. Another Tree Notation]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:sequence>
        <xs:element minOccurs="0" ref="tei:label"/>
      ...
      <xs:attribute name="value" type="xs:anyURI">
        <xs:annotation>
          <xs:documentation>indicates the value of an embedding leaf, which is a feature structure or other analytic element.</xs:documentation>
        </xs:annotation>
      </xs:attribute>
    </xs:complexType>
  </xs:element>
  <xs:element name="forest">
    <xs:annotation>
      <xs:documentation>provides for groups of rooted trees. [19.3. Another Tree Notation]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:choice maxOccurs="unbounded">
        <xs:element ref="tei:tree"/>
  ...
  <xs:element name="listForest">
    <xs:annotation>
      <xs:documentation>provides for lists of forests. [19.3. Another Tree Notation]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:sequence>
        <xs:element maxOccurs="unbounded" ref="tei:forest"/>
      </xs:sequence>
      <xs:attributeGroup ref="tei:att.global.attributes"/>
      <xs:attribute name="type">
        <xs:annotation>
  ...
  <xs:attributeGroup name="att.duration.attributes">
    <xs:attributeGroup ref="tei:att.duration.w3c.attributes"/>
    <xs:attributeGroup ref="tei:att.duration.iso.attributes"/>
  </xs:attributeGroup>
  <xs:group name="model.global.spoken">
    <xs:choice>
      <xs:element ref="tei:pause"/>
      <xs:element ref="tei:vocal"/>
      <xs:element ref="tei:kinesic"/>
      <xs:element ref="tei:incident"/>
      <xs:element ref="tei:writing"/>
      <xs:element ref="tei:shift"/>
    </xs:choice>
  </xs:group>
  ...
  <xs:element name="recording">
    ...
    <xs:complexType>
      <xs:choice minOccurs="0" maxOccurs="unbounded">
        <xs:group ref="tei:model.recordingPart"/>
        <xs:group ref="tei:model.pLike"/>
      </xs:choice>
      <xs:attributeGroup ref="tei:att.global.attributes"/>
      <xs:attributeGroup ref="tei:att.declarable.attributes"/>
...
Suggested values include: 1] tempo; 2] loud; 3] pitch; 4] tension; 5] rhythm; 6] voice</xs:documentation>
  ...
  <xs:group name="model.rdgLike">
    <xs:sequence>
      <xs:element ref="tei:rdg"/>
    </xs:sequence>
  </xs:group>
  <xs:group name="model.rdgPart">
    <xs:choice>
      <xs:element ref="tei:wit"/>
      <xs:element ref="tei:witStart"/>
      <xs:element ref="tei:witEnd"/>
      <xs:element ref="tei:lacunaStart"/>
      <xs:element ref="tei:lacunaEnd"/>
    </xs:choice>
  </xs:group>
  <xs:attributeGroup name="att.rdgPart.attributes">
    <xs:attributeGroup ref="tei:att.rdgPart.attribute.wit"/>
  </xs:attributeGroup>
  ...
  <xs:attributeGroup name="att.textCritical.attributes">
    <xs:attributeGroup ref="tei:att.source.attributes"/>
    <xs:attributeGroup ref="tei:att.written.attributes"/>
    <xs:attributeGroup ref="tei:att.textCritical.attribute.type"/>
    <xs:attributeGroup ref="tei:att.textCritical.attribute.cause"/>
    <xs:attributeGroup ref="tei:att.textCritical.attribute.varSeq"/>
  </xs:attributeGroup>
...
Sample values include: 1] homeoteleuton; 2] homeoarchy; 3] paleographicConfusion; 4] haplography; 5] dittography; 6] falseEmendation</xs:documentation>
  ...
  <xs:attributeGroup name="att.textCritical.attribute.varSeq">
    <xs:attribute name="varSeq" type="xs:nonNegativeInteger">
      <xs:annotation>
        <xs:documentation>(variant sequence) provides a number indicating the position of this reading in a sequence, when there is reason to presume a sequence to the variants. </xs:documentation>
      </xs:annotation>
    </xs:attribute>
  </xs:attributeGroup>
  <xs:element name="app">
  ...
  <xs:element name="listApp">
    <xs:annotation>
      <xs:documentation>(list of apparatus entries) contains a list of apparatus entries. [12.2. Linking the Apparatus to the Text]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:sequence>
        <xs:group minOccurs="0" maxOccurs="unbounded" ref="tei:model.headLike"/>
  ...
  <xs:element name="lem">
    ...
    <xs:complexType mixed="true">
      <xs:choice minOccurs="0" maxOccurs="unbounded">
        ...
        <xs:group ref="tei:model.inter"/>
        <xs:group ref="tei:model.global"/>
        <xs:group ref="tei:model.rdgPart"/>
      </xs:choice>
      <xs:attributeGroup ref="tei:att.global.attributes"/>
  ...
  <xs:element name="rdgGrp">
    <xs:annotation>
      <xs:documentation>(reading group) within a textual variation, groups two or more readings perceived to have a genetic relationship or other affinity. [12.1. The Apparatus Entry, Readings, and Witnesses]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:choice maxOccurs="unbounded">
        <xs:sequence>
          <xs:element ref="tei:rdgGrp"/>
          <xs:element minOccurs="0" ref="tei:wit"/>
        </xs:sequence>
        <xs:sequence minOccurs="0" maxOccurs="unbounded">
          <xs:sequence minOccurs="0">
            <xs:element ref="tei:lem"/>
            <xs:element minOccurs="0" ref="tei:wit"/>
          </xs:sequence>
          <xs:sequence>
            <xs:group ref="tei:model.rdgLike"/>
  ...
  <xs:element name="witDetail">
    <xs:annotation>
      <xs:documentation>(witness detail) gives further information about a particular witness, or witnesses, to a particular reading. [12.1. The Apparatus Entry, Readings, and Witnesses]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:complexContent>
        <xs:extension base="tei:macro.phraseSeq">
  ...
  <xs:element name="wit">
    <xs:annotation>
      <xs:documentation>contains a list of one or more sigla of witnesses attesting a given reading, in a textual variation. [12.1.4. Witness Information]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:complexContent>
        <xs:extension base="tei:macro.phraseSeq">
          <xs:attributeGroup ref="tei:att.global.attributes"/>
          <xs:attributeGroup ref="tei:att.rdgPart.attributes"/>
        </xs:extension>
      </xs:complexContent>
    </xs:complexType>
  </xs:element>
  <xs:element name="listWit">
    <xs:annotation>
      <xs:documentation>(witness list) lists definitions for all the witnesses referred to by a critical apparatus, optionally grouped hierarchically. [12.1. The Apparatus Entry, Readings, and Witnesses]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:sequence>
        <xs:group minOccurs="0" ref="tei:model.headLike"/>
        <xs:choice maxOccurs="unbounded">
          <xs:element ref="tei:witness"/>
          <xs:element ref="tei:listWit"/>
        </xs:choice>
      </xs:sequence>
      <xs:attributeGroup ref="tei:att.global.attributes"/>
  ...
  <xs:element name="witness">
    <xs:annotation>
      <xs:documentation>contains either a description of a single witness referred to within the critical apparatus, or a list of witnesses which is to be referred to by a single sigil. [12.1. The Apparatus Entry, Readings, and Witnesses]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:complexContent>
        <xs:extension base="tei:macro.limitedContent">
  ...
  <xs:element name="witStart">
    <xs:annotation>
      <xs:documentation>(fragmented witness start) indicates the beginning, or resumption, of the text of a fragmentary witness. [12.1.5. Fragmentary Witnesses]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:attributeGroup ref="tei:att.global.attributes"/>
      <xs:attributeGroup ref="tei:att.rdgPart.attributes"/>
  ...
  <xs:element name="witEnd">
    <xs:annotation>
      <xs:documentation>(fragmented witness end) indicates the end, or suspension, of the text of a fragmentary witness. [12.1.5. Fragmentary Witnesses]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:attributeGroup ref="tei:att.global.attributes"/>
      <xs:attributeGroup ref="tei:att.rdgPart.attributes"/>
  ...
  <xs:element name="lacunaStart">
    <xs:annotation>
      <xs:documentation>indicates the beginning of a lacuna in the text of a mostly complete textual witness. [12.1.5. Fragmentary Witnesses]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:attributeGroup ref="tei:att.global.attributes"/>
      <xs:attributeGroup ref="tei:att.rdgPart.attributes"/>
  ...
  <xs:element name="lacunaEnd">
    <xs:annotation>
      <xs:documentation>indicates the end of a lacuna in a mostly complete textual witness. [12.1.5. Fragmentary Witnesses]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:attributeGroup ref="tei:att.global.attributes"/>
      <xs:attributeGroup ref="tei:att.rdgPart.attributes"/>
  ...
  <xs:element name="variantEncoding">
    <xs:annotation>
      <xs:documentation>declares the method used to encode text-critical variants. [12.1.1. The Apparatus Entry]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:attributeGroup ref="tei:att.global.attributes"/>
  ...
  <xs:element name="body">
    ...
    <xs:complexType>
      <xs:sequence>
        ...
        <xs:sequence minOccurs="0">
          <xs:group ref="tei:model.divGenLike"/>
          <xs:choice minOccurs="0" maxOccurs="unbounded">
            <xs:group ref="tei:model.global"/>
            <xs:group ref="tei:model.divGenLike"/>
          </xs:choice>
        ...
        <xs:choice>
          ...
          <xs:sequence maxOccurs="unbounded">
            <xs:group ref="tei:model.div1Like"/>
            <xs:choice minOccurs="0" maxOccurs="unbounded">
              <xs:group ref="tei:model.global"/>
              <xs:group ref="tei:model.divGenLike"/>
            </xs:choice>
      ...
      <xs:sequence>
        ...
        <xs:sequence minOccurs="0">
          <xs:choice>
            <xs:sequence maxOccurs="unbounded">
              <xs:choice>
                <xs:group ref="tei:model.div2Like"/>
                <xs:group ref="tei:model.divGenLike"/>
              </xs:choice>
              <xs:group minOccurs="0" maxOccurs="unbounded" ref="tei:model.global"/>
            </xs:sequence>
      ...
      <xs:sequence>
        ...
        <xs:sequence minOccurs="0">
          <xs:choice>
            <xs:sequence maxOccurs="unbounded">
              <xs:choice>
                <xs:group ref="tei:model.div3Like"/>
                <xs:group ref="tei:model.divGenLike"/>
              </xs:choice>
              <xs:group minOccurs="0" maxOccurs="unbounded" ref="tei:model.global"/>
            </xs:sequence>
      ...
      <xs:sequence>
        ...
        <xs:sequence minOccurs="0">
          <xs:choice>
            <xs:sequence maxOccurs="unbounded">
              <xs:choice>
                <xs:group ref="tei:model.div4Like"/>
                <xs:group ref="tei:model.divGenLike"/>
              </xs:choice>
              <xs:group minOccurs="0" maxOccurs="unbounded" ref="tei:model.global"/>
            </xs:sequence>
      ...
      <xs:sequence>
        ...
        <xs:sequence minOccurs="0">
          <xs:choice>
            <xs:sequence maxOccurs="unbounded">
              <xs:choice>
                <xs:group ref="tei:model.div5Like"/>
                <xs:group ref="tei:model.divGenLike"/>
              </xs:choice>
              <xs:group minOccurs="0" maxOccurs="unbounded" ref="tei:model.global"/>
            </xs:sequence>
      ...
      <xs:sequence>
        ...
        <xs:sequence minOccurs="0">
          <xs:choice>
            <xs:sequence maxOccurs="unbounded">
              <xs:choice>
                <xs:group ref="tei:model.div6Like"/>
                <xs:group ref="tei:model.divGenLike"/>
              </xs:choice>
              <xs:group minOccurs="0" maxOccurs="unbounded" ref="tei:model.global"/>
            </xs:sequence>
      ...
      <xs:sequence>
        ...
        <xs:sequence minOccurs="0">
          <xs:choice>
            <xs:sequence maxOccurs="unbounded">
              <xs:choice>
                <xs:group ref="tei:model.div7Like"/>
                <xs:group ref="tei:model.divGenLike"/>
              </xs:choice>
              <xs:group minOccurs="0" maxOccurs="unbounded" ref="tei:model.global"/>
            </xs:sequence>
...
Sample values include: 1] glued; 2] pinned; 3] sewn</xs:documentation>
  ...
  <xs:element name="zone">
    <xs:annotation>
      <xs:documentation>defines any two-dimensional area within a surface element. [11.1. Digital Facsimiles 11.2.2. Embedded Transcription]</xs:documentation>
    </xs:annotation>
    <xs:complexType mixed="true">
      <xs:choice minOccurs="0" maxOccurs="unbounded">
        <xs:group ref="tei:model.graphicLike"/>
  ...
  <xs:element name="addSpan">
    <xs:annotation>
      <xs:documentation>(added span of text) marks the beginning of a longer sequence of text added by an author, scribe, annotator or corrector (see also add). [11.3.1.4. Additions and Deletions]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:attributeGroup ref="tei:att.global.attributes"/>
      <xs:attributeGroup ref="tei:att.transcriptional.attributes"/>
...
Sample values include: 1] header; 2] footer; 3] pageNum(page number) ; 4] lineNum(line number) ; 5] sig(signature) ; 6] catch(catchword) </xs:documentation>
  ...
  <xs:element name="handNotes">
    <xs:annotation>
      <xs:documentation>contains one or more handNote elements documenting the different hands identified within the source texts. [11.3.2.1. Document Hands]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:sequence>
        <xs:element maxOccurs="unbounded" ref="tei:handNote"/>
  ...
  <xs:element name="handShift">
    ...
    <xs:complexType>
      ...
      <xs:attribute name="new" type="xs:anyURI">
        <xs:annotation>
          <xs:documentation>indicates a handNote element describing the hand concerned.</xs:documentation>
        </xs:annotation>
      </xs:attribute>
    </xs:complexType>
  </xs:element>
  <xs:element name="am">
    <xs:annotation>
      <xs:documentation>(abbreviation marker) contains a sequence of letters or signs present in an abbreviation which are omitted or replaced in the expanded form of the abbreviation. [11.3.1.2. Abbreviation and Expansion]</xs:documentation>
    </xs:annotation>
    <xs:complexType mixed="true">
      <xs:choice minOccurs="0" maxOccurs="unbounded">
        <xs:group ref="tei:model.gLike"/>
  ...
  <xs:element name="subst">
    <xs:annotation>
      <xs:documentation>(substitution) groups one or more deletions with one or more additions when the combination is to be regarded as a single intervention in the text. [11.3.1.5. Substitutions]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:choice maxOccurs="unbounded">
        <xs:element ref="tei:add"/>
  ...
  <xs:attributeGroup name="att.metrical.attributes">
    <xs:attributeGroup ref="tei:att.metrical.attribute.met"/>
    <xs:attributeGroup ref="tei:att.metrical.attribute.real"/>
  ...
  <xs:attributeGroup name="att.enjamb.attributes">
    <xs:attributeGroup ref="tei:att.enjamb.attribute.enjamb"/>
  </xs:attributeGroup>
...
Sample values include: 1] no; 2] yes; 3] weak; 4] strong</xs:documentation>
  ...
  <xs:element name="metDecl">
    ...
    <xs:complexType>
      <xs:choice>
        ...
        <xs:element maxOccurs="unbounded" ref="tei:metSym"/>
      </xs:choice>
      <xs:attributeGroup ref="tei:att.global.attributes"/>
      <xs:attributeGroup ref="tei:att.declarable.attributes"/>
  ...
  <xs:element name="metSym">
    <xs:annotation>
      <xs:documentation>(metrical notation symbol) documents the intended significance of a particular character or character sequence within a metrical notation, either explicitly or in terms of other symbol elements in the same metDecl. [6.6. Metrical Notation Declaration]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:complexContent>
        <xs:extension base="tei:macro.phraseSeq.limited">
          ...
          <xs:attribute name="terminal" default="true" type="xs:boolean">
            <xs:annotation>
  ...
  <xs:element name="caesura">
    <xs:annotation>
      <xs:documentation>marks the point at which a metrical line may be divided. [6.2. Components of the Verse Line]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:attributeGroup ref="tei:att.global.attributes"/>
    </xs:complexType>
  ...
  <xs:attributeGroup name="att.repeatable.attribute.context">
    <xs:attribute name="context">
      <xs:annotation>
        <xs:documentation>supplies an XPath identifying a context within which this component of a content model must be found</xs:documentation>
      </xs:annotation>
    </xs:attribute>
  </xs:attributeGroup>
  ...
  <xs:group name="model.contentPart">
    <xs:choice>
      <xs:element ref="tei:classRef"/>
      <xs:element ref="tei:elementRef"/>
      <xs:element ref="tei:macroRef"/>
      <xs:element ref="tei:sequence"/>
      <xs:element ref="tei:alternate"/>
      <xs:element ref="tei:dataRef"/>
      <xs:element ref="tei:valList"/>
      <xs:element ref="tei:textNode"/>
    </xs:choice>
  </xs:group>
  <xs:attributeGroup name="att.combinable.attributes">
    <xs:attributeGroup ref="tei:att.deprecated.attributes"/>
    <xs:attributeGroup ref="tei:att.combinable.attribute.mode"/>
  </xs:attributeGroup>
  ...
  <xs:attributeGroup name="att.deprecated.attributes">
    <xs:attributeGroup ref="tei:att.deprecated.attribute.validUntil"/>
  </xs:attributeGroup>
  ...
  <xs:attributeGroup name="att.namespaceable.attributes">
    <xs:attributeGroup ref="tei:att.namespaceable.attribute.ns"/>
  </xs:attributeGroup>
  <xs:attributeGroup name="att.namespaceable.attribute.ns">
    <xs:attribute name="ns" default="http://www.tei-c.org/ns/1.0" type="xs:anyURI">
      <xs:annotation>
  ...
  <xs:element name="att">
    ...
    <xs:complexType>
      <xs:simpleContent>
        <xs:extension base="tei:data.name">
          <xs:attributeGroup ref="tei:att.global.attributes"/>
          <xs:attribute name="scheme" default="TEI">
            <xs:annotation>
              <xs:documentation>supplies an identifier for the scheme in which this name is defined.
Sample values include: 1] TEI(text encoding initiative) ; 2] DBK(docbook) ; 3] XX(unknown) ; 4] imaginary; 5] XHTML; 6] XML; 7] XI</xs:documentation>
            </xs:annotation>
            <xs:simpleType>
              <xs:restriction base="xs:token">
                <xs:pattern value="(\p{L}|\p{N}|\p{P}|\p{S})+"/>
  ...
  <xs:element name="eg">
    <xs:annotation>
      <xs:documentation>(example) contains any kind of illustrative example. [22.5. Element Specifications 22.5.4. Attribute List Specification]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:complexContent>
        <xs:extension base="tei:macro.phraseSeq">
...
Sample values include: 1] TEI(text encoding initiative) ; 2] DBK(docbook) ; 3] XX(unknown) ; 4] Schematron; 5] HTML</xs:documentation>
  ...
  <xs:element name="val">
    <xs:annotation>
      <xs:documentation>(value) contains a single attribute value. [22. Documentation Elements 22.5.4. Attribute List Specification]</xs:documentation>
    </xs:annotation>
    <xs:complexType mixed="true">
      <xs:attributeGroup ref="tei:att.global.attributes"/>
    </xs:complexType>
  ...
  <xs:element name="specList">
    ...
    <xs:complexType>
      <xs:sequence>
        <xs:element maxOccurs="unbounded" ref="tei:specDesc"/>
      </xs:sequence>
      <xs:attributeGroup ref="tei:att.global.attributes"/>
    </xs:complexType>
  </xs:element>
  ...
  <xs:element name="elementRef">
    <xs:annotation>
      <xs:documentation>points to the specification for some element which is to be included in a schema [22.2. Modules and Schemas]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:attributeGroup ref="tei:att.global.attributes"/>
      <xs:attributeGroup ref="tei:att.repeatable.attributes"/>
  ...
  <xs:element name="macroRef">
    <xs:annotation>
      <xs:documentation>points to the specification for some pattern which is to be included in a schema [22.7. Macro Specifications]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:attributeGroup ref="tei:att.global.attributes"/>
      <xs:attributeGroup ref="tei:att.readFrom.attributes"/>
  ...
  <xs:element name="moduleRef">
    <xs:annotation>
      <xs:documentation>(module reference) references a module which is to be incorporated into a schema. [22.2. Modules and Schemas]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:sequence>
        <xs:element minOccurs="0" ref="tei:content"/>
      </xs:sequence>
      <xs:attributeGroup ref="tei:att.global.attributes"/>
      <xs:attributeGroup ref="tei:att.readFrom.attributes"/>
  ...
  <xs:element name="moduleSpec">
    ...
    <xs:complexType>
      <xs:sequence>
        ...
        <xs:element minOccurs="0" maxOccurs="unbounded" ref="tei:exemplum"/>
        <xs:element minOccurs="0" ref="tei:remarks"/>
        <xs:element minOccurs="0" maxOccurs="unbounded" ref="tei:listRef"/>
      </xs:sequence>
      <xs:attributeGroup ref="tei:att.global.attributes"/>
  ...
  <xs:element name="specGrpRef">
    <xs:annotation>
      <xs:documentation>(reference to a specification group) indicates that the declarations contained by the specGrp referenced should be inserted at this point. [22.2. Modules and Schemas]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:attributeGroup ref="tei:att.global.attributes"/>
      <xs:attribute name="target" use="required" type="xs:anyURI">
  ...
  <xs:element name="elementSpec">
    ...
    <xs:complexType>
      <xs:sequence>
        ...
        <xs:element minOccurs="0" ref="tei:classes"/>
        <xs:element minOccurs="0" ref="tei:content"/>
        <xs:element minOccurs="0" ref="tei:valList"/>
        <xs:element minOccurs="0" maxOccurs="unbounded" ref="tei:constraintSpec"/>
        <xs:element minOccurs="0" ref="tei:attList"/>
        <xs:choice minOccurs="0" maxOccurs="unbounded">
          <xs:element ref="tei:model"/>
          <xs:element ref="tei:modelGrp"/>
          <xs:element ref="tei:modelSequence"/>
        </xs:choice>
        <xs:element minOccurs="0" maxOccurs="unbounded" ref="tei:exemplum"/>
        <xs:element minOccurs="0" maxOccurs="unbounded" ref="tei:remarks"/>
        <xs:element minOccurs="0" maxOccurs="unbounded" ref="tei:listRef"/>
      </xs:sequence>
      <xs:attributeGroup ref="tei:att.global.attributes"/>
      <xs:attributeGroup ref="tei:att.identified.attributes"/>
  ...
  <xs:element name="dataSpec">
    <xs:annotation>
      <xs:documentation>(datatype specification) documents a datatype. [22.3. Specification Elements 22.7. Macro Specifications]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:sequence>
        <xs:choice minOccurs="0" maxOccurs="unbounded">
  ...
  <xs:element name="remarks">
    <xs:annotation>
      <xs:documentation>contains any commentary or discussion about the usage of an element, attribute, class, or entity not otherwise documented within the containing element. [22.5. Element Specifications 22.5.4. Attribute List Specification 22.6. Class Specifications 22.7. Macro Specifications]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:group maxOccurs="unbounded" ref="tei:model.pLike"/>
      <xs:attributeGroup ref="tei:att.global.attributes"/>
  ...
  <xs:element name="classes">
    ...
    <xs:complexType>
      <xs:sequence>
        <xs:element minOccurs="0" maxOccurs="unbounded" ref="tei:memberOf"/>
      </xs:sequence>
      <xs:attributeGroup ref="tei:att.global.attributes"/>
  ...
  <xs:element name="memberOf">
    <xs:annotation>
      <xs:documentation>specifies class membership of the documented element or class. [22.4.3. Classification of Components]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:complexContent>
        <xs:extension base="tei:macro.xtext">
  ...
  <xs:element name="model">
    <xs:annotation>
      <xs:documentation>describes the processing intended for a specified element. [22.5.5.1. The TEI processing model]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:sequence>
        <xs:choice minOccurs="0" maxOccurs="unbounded">
        ...
        <xs:element minOccurs="0" maxOccurs="unbounded" ref="tei:param"/>
        <xs:element minOccurs="0" maxOccurs="unbounded" ref="tei:outputRendition"/>
      </xs:sequence>
      <xs:attributeGroup ref="tei:att.global.attributes"/>
      <xs:attribute name="behaviour" use="required">
        <xs:annotation>
          <xs:documentation>names the process or function which this processing model uses in order to produce output.
Suggested values include: 1] alternate; 2] anchor; 3] block; 4] body; 5] break; 6] cell; 7] cit; 8] document; 9] figure; 10] glyph; 11] graphic; 12] heading; 13] index; 14] inline; 15] link; 16] list; 17] listItem; 18] metadata; 19] note; 20] omit; 21] paragraph; 22] row; 23] section; 24] table; 25] text; 26] title</xs:documentation>
        </xs:annotation>
        <xs:simpleType>
          <xs:union>
            <xs:simpleType>
            ...
            <xs:simpleType>
              <xs:restriction base="xs:token">
                <xs:enumeration value="link">
                  <xs:annotation>
                    <xs:documentation>create hyperlink</xs:documentation>
                  </xs:annotation>
                </xs:enumeration>
              </xs:restriction>
            </xs:simpleType>
            <xs:simpleType>
              <xs:restriction base="xs:token">
                <xs:enumeration value="list">
                  <xs:annotation>
                    <xs:documentation>create a list </xs:documentation>
                  </xs:annotation>
                </xs:enumeration>
              </xs:restriction>
            </xs:simpleType>
            <xs:simpleType>
              <xs:restriction base="xs:token">
                <xs:enumeration value="listItem">
                  <xs:annotation>
                    <xs:documentation>create a list item</xs:documentation>
                  </xs:annotation>
                </xs:enumeration>
              </xs:restriction>
            </xs:simpleType>
            <xs:simpleType>
              <xs:restriction base="xs:token">
                <xs:enumeration value="metadata">
                  <xs:annotation>
                    <xs:documentation>create metadata section</xs:documentation>
                  </xs:annotation>
                </xs:enumeration>
              </xs:restriction>
            </xs:simpleType>
            <xs:simpleType>
              <xs:restriction base="xs:token">
                <xs:enumeration value="note">
                  <xs:annotation>
                    <xs:documentation>create a note, often out of line, depending on the value of place; could be margin, footnote, endnote, inline</xs:documentation>
                  </xs:annotation>
                </xs:enumeration>
              </xs:restriction>
            </xs:simpleType>
            <xs:simpleType>
              <xs:restriction base="xs:token">
                <xs:enumeration value="omit">
                  <xs:annotation>
                    <xs:documentation>do nothing, do not process children</xs:documentation>
                  </xs:annotation>
                </xs:enumeration>
              </xs:restriction>
            </xs:simpleType>
            <xs:simpleType>
              <xs:restriction base="xs:token">
                <xs:enumeration value="paragraph">
                  <xs:annotation>
                    <xs:documentation>create a paragraph out of content.</xs:documentation>
                  </xs:annotation>
                </xs:enumeration>
              </xs:restriction>
            </xs:simpleType>
            <xs:simpleType>
              <xs:restriction base="xs:token">
                <xs:enumeration value="row">
                  <xs:annotation>
                    <xs:documentation>create a table row</xs:documentation>
                  </xs:annotation>
                </xs:enumeration>
              </xs:restriction>
            </xs:simpleType>
            <xs:simpleType>
              <xs:restriction base="xs:token">
                <xs:enumeration value="section">
                  <xs:annotation>
                    <xs:documentation>create a new section of the output document</xs:documentation>
                  </xs:annotation>
                </xs:enumeration>
              </xs:restriction>
            </xs:simpleType>
            <xs:simpleType>
              <xs:restriction base="xs:token">
                <xs:enumeration value="table">
                  <xs:annotation>
                    <xs:documentation>create a table</xs:documentation>
                  </xs:annotation>
                </xs:enumeration>
              </xs:restriction>
            </xs:simpleType>
            <xs:simpleType>
              <xs:restriction base="xs:token">
                <xs:enumeration value="text">
                  <xs:annotation>
                    <xs:documentation>create literal text</xs:documentation>
                  </xs:annotation>
                </xs:enumeration>
              </xs:restriction>
            </xs:simpleType>
            <xs:simpleType>
              <xs:restriction base="xs:token">
                <xs:enumeration value="title">
                  <xs:annotation>
                    <xs:documentation>create document title</xs:documentation>
                  </xs:annotation>
                </xs:enumeration>
              </xs:restriction>
            </xs:simpleType>
      ...
      <xs:attribute name="predicate">
        <xs:annotation>
          <xs:documentation>the condition under which this model applies, given as an XPath predicate expression.</xs:documentation>
        </xs:annotation>
      </xs:attribute>
      <xs:attribute name="useSourceRendition" type="xs:boolean">
        <xs:annotation>
          <xs:documentation>whether to obey any rendition attribute which is present.</xs:documentation>
        </xs:annotation>
      </xs:attribute>
      <xs:attribute name="output">
        <xs:annotation>
          <xs:documentation>the intended output.
Sample values include: 1] web; 2] print; 3] plain</xs:documentation>
        </xs:annotation>
        <xs:simpleType>
          <xs:restriction base="xs:token">
            <xs:pattern value="(\p{L}|\p{N}|\p{P}|\p{S})+"/>
  ...
  <xs:element name="modelSequence">
    <xs:annotation>
      <xs:documentation>any sequence of model or modelSequence elements which is to be processed as a single set of actions [22.5.5.7. Model sequence]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:sequence>
        <xs:choice minOccurs="0" maxOccurs="unbounded">
        ...
        <xs:element maxOccurs="unbounded" ref="tei:model"/>
      </xs:sequence>
      <xs:attributeGroup ref="tei:att.global.attributes"/>
      <xs:attribute name="predicate">
        <xs:annotation>
      ...
      <xs:attribute name="output">
        <xs:annotation>
          <xs:documentation>the intended output method
Suggested values include: 1] web; 2] print; 3] plaintext</xs:documentation>
        </xs:annotation>
        <xs:simpleType>
          <xs:union>
            <xs:simpleType>
  ...
  <xs:element name="modelGrp">
    <xs:annotation>
      <xs:documentation>any grouping of model or modelSequence elements with a common output method [22.5.5.4. Model Contexts and Outputs]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:sequence>
        <xs:choice minOccurs="0" maxOccurs="unbounded">
  ...
  <xs:element name="outputRendition">
    ...
    <xs:complexType mixed="true">
      ...
      <xs:attribute name="scope" type="tei:data.enumerated">
        <xs:annotation>
          <xs:documentation>provides a way of defining pseudo-elements, that is, styling rules applicable to specific sub-portions of an element.
Sample values include: 1] first-line; 2] first-letter; 3] before; 4] after</xs:documentation>
        </xs:annotation>
      </xs:attribute>
    </xs:complexType>
  ...
  <xs:element name="paramList">
    ...
    <xs:complexType>
      <xs:sequence>
        <xs:element minOccurs="0" maxOccurs="unbounded" ref="tei:paramSpec"/>
      </xs:sequence>
      <xs:attributeGroup ref="tei:att.global.attributes"/>
    </xs:complexType>
  </xs:element>
  <xs:element name="paramSpec">
    <xs:annotation>
      <xs:documentation>supplies specification for one parameter of a model behaviour [22.5.5.8. Defining a processing model]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:choice minOccurs="0" maxOccurs="unbounded">
        <xs:group ref="tei:model.glossLike"/>
  ...
  <xs:element name="param">
    <xs:annotation>
      <xs:documentation>provides a parameter for a model behaviour by supplying its name and an XPath expression identifying the location of its content. [22.5.5.5. Behaviours and their parameters]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:attributeGroup ref="tei:att.global.attributes"/>
      <xs:attribute name="name" use="required">
        <xs:annotation>
          <xs:documentation>a name for the parameter being supplied
Suggested values include: 1] alternate; 2] default; 3] height; 4] id; 5] label; 6] level; 7] link; 8] place; 9] type; 10] url; 11] width</xs:documentation>
        </xs:annotation>
      </xs:attribute>
      <xs:attribute name="value" use="required">
        <xs:annotation>
  ...
  <xs:element name="content">
    <xs:annotation>
      <xs:documentation>(content model) contains the text of a declaration for the schema documented. [22.5. Element Specifications]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:choice maxOccurs="unbounded">
        <xs:group ref="tei:macro.anyXML"/>
        <xs:group ref="tei:model.contentPart"/>
      </xs:choice>
      <xs:attributeGroup ref="tei:att.global.attributes"/>
  ...
  <xs:element name="sequence">
    ...
    <xs:complexType>
      <xs:group maxOccurs="unbounded" ref="tei:model.contentPart"/>
      <xs:attributeGroup ref="tei:att.global.attributes"/>
      <xs:attributeGroup ref="tei:att.repeatable.attributes"/>
  ...
  <xs:element name="alternate">
    <xs:annotation>
      <xs:documentation>an alternation of references</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:group maxOccurs="unbounded" ref="tei:model.contentPart"/>
      <xs:attributeGroup ref="tei:att.global.attributes"/>
  ...
  <xs:element name="constraint">
    <xs:annotation>
      <xs:documentation>(constraint rules) the formal rules of a constraint [22.5. Element Specifications]</xs:documentation>
    </xs:annotation>
    <xs:complexType mixed="true">
      <xs:group minOccurs="0" maxOccurs="unbounded" ref="tei:macro.anyXML"/>
      <xs:attributeGroup ref="tei:att.global.attributes"/>
    </xs:complexType>
  </xs:element>
  <xs:element name="constraintSpec">
    <xs:annotation>
      <xs:documentation>(constraint on schema) contains a constraint, expressed in some formal syntax, which cannot be expressed in the structural content model [22.5. Element Specifications]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:sequence>
        <xs:choice minOccurs="0" maxOccurs="unbounded">
        ...
        <xs:element minOccurs="0" ref="tei:constraint"/>
      </xs:sequence>
      <xs:attributeGroup ref="tei:att.global.attributes"/>
      <xs:attributeGroup ref="tei:att.identified.attributes"/>
      <xs:attributeGroup ref="tei:att.typed.attributes"/>
      <xs:attribute name="scheme" use="required">
        <xs:annotation>
          <xs:documentation>supplies the name of the language in which the constraints are defined
Suggested values include: 1] schematron(Schematron) ; 2] isoschematron(ISO Schematron) </xs:documentation>
        </xs:annotation>
        <xs:simpleType>
          <xs:union>
            <xs:simpleType>
  ...
  <xs:element name="attList">
    <xs:annotation>
      <xs:documentation>contains documentation for all the attributes associated with this element, as a series of attDef elements. [22.5. Element Specifications 22.6. Class Specifications]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:choice maxOccurs="unbounded">
        <xs:element ref="tei:attRef"/>
        <xs:element ref="tei:attDef"/>
        <xs:element ref="tei:attList"/>
      </xs:choice>
      <xs:attributeGroup ref="tei:att.global.attributes"/>
  ...
  <xs:element name="attDef">
    <xs:annotation>
      <xs:documentation>(attribute definition) contains the definition of a single attribute. [22.5.4. Attribute List Specification]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:sequence>
        <xs:choice minOccurs="0" maxOccurs="unbounded">
        ...
        <xs:element minOccurs="0" ref="tei:datatype"/>
        <xs:element minOccurs="0" maxOccurs="unbounded" ref="tei:constraintSpec"/>
        <xs:element minOccurs="0" ref="tei:defaultVal"/>
        <xs:choice minOccurs="0">
          <xs:element ref="tei:valList"/>
          <xs:element maxOccurs="unbounded" ref="tei:valDesc"/>
        </xs:choice>
        <xs:element minOccurs="0" maxOccurs="unbounded" ref="tei:exemplum"/>
        <xs:element minOccurs="0" maxOccurs="unbounded" ref="tei:remarks"/>
      </xs:sequence>
  ...
  <xs:element name="attRef">
    ...
    <xs:complexType>
      ...
      <xs:attribute name="class">
        <xs:annotation>
          <xs:documentation>the name of the attribute class</xs:documentation>
        </xs:annotation>
        <xs:simpleType>
          <xs:restriction base="xs:token">
            <xs:pattern value="(\p{L}|\p{N}|\p{P}|\p{S})+"/>
  ...
  <xs:element name="datatype">
    <xs:annotation>
      <xs:documentation>specifies the declared value for an attribute, by referring to any datatype defined by the chosen schema language. [ 22.5.4. Attribute List Specification]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:choice>
        <xs:element ref="tei:textNode"/>
        <xs:element ref="tei:dataRef"/>
        <xs:group ref="tei:macro.schemaPattern"/>
      </xs:choice>
      <xs:attributeGroup ref="tei:att.global.attributes"/>
      <xs:attribute name="minOccurs" default="1" type="xs:nonNegativeInteger">
        <xs:annotation>
  ...
  <xs:element name="dataRef">
    <xs:annotation>
      <xs:documentation>identifies the datatype of an attribute value, either by referencing an item in an externally defined datatype library, or by pointing to a TEI-defined data specification [22.5.4.1. Datatypes]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:attributeGroup ref="tei:att.global.attributes"/>
      <xs:attributeGroup ref="tei:att.readFrom.attributes"/>
      <xs:attribute name="key" type="xs:NCName">
        <xs:annotation>
          <xs:documentation>the identifier used for this datatype specification</xs:documentation>
        </xs:annotation>
      </xs:attribute>
      <xs:attribute name="name" type="xs:NCName">
        <xs:annotation>
          <xs:documentation>the name of a datatype in the list provided by XML Schemas: Part 2: Datatypes</xs:documentation>
        </xs:annotation>
      </xs:attribute>
      <xs:attribute name="ref" type="xs:NCName">
        <xs:annotation>
          <xs:documentation>a pointer to a datatype defined in some datatype library</xs:documentation>
        </xs:annotation>
      </xs:attribute>
      <xs:attribute name="restriction" type="xs:token">
        <xs:annotation>
  ...
  <xs:element name="defaultVal">
    <xs:annotation>
      <xs:documentation>(default value) specifies the default declared value for an attribute. [22.5.4. Attribute List Specification]</xs:documentation>
    </xs:annotation>
    <xs:complexType mixed="true">
      <xs:attributeGroup ref="tei:att.global.attributes"/>
    </xs:complexType>
  ...
  <xs:element name="valDesc">
    <xs:annotation>
      <xs:documentation>(value description) specifies any semantic or syntactic constraint on the value that an attribute may take, additional to the information carried by the datatype element. [22.5.4. Attribute List Specification]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:complexContent>
        <xs:extension base="tei:macro.phraseSeq.limited">
  ...
  <xs:element name="valItem">
    <xs:annotation>
      <xs:documentation>documents a single value in a predefined list of values. [22.5.4. Attribute List Specification]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:sequence>
        <xs:choice minOccurs="0" maxOccurs="unbounded">
        ...
        <xs:element minOccurs="0" ref="tei:paramList"/>
      </xs:sequence>
      <xs:attributeGroup ref="tei:att.global.attributes"/>
      <xs:attributeGroup ref="tei:att.combinable.attributes"/>
  ...
  <xs:element name="valList">
    <xs:annotation>
      <xs:documentation>(value list) contains one or more valItem elements defining possible values. [22.5.4. Attribute List Specification]</xs:documentation>
    </xs:annotation>
    <xs:complexType>
      <xs:sequence>
        <xs:element minOccurs="0" maxOccurs="unbounded" ref="tei:valItem"/>
      </xs:sequence>
      <xs:attributeGroup ref="tei:att.global.attributes"/>
      <xs:attributeGroup ref="tei:att.combinable.attributes"/>
...
<!--Downloaded by eulxml 1.1.2 on 2016-06-01--></xs:schema>
